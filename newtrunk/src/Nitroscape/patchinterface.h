    ...
    public base
{
    private:
        ...
        // !amount of carbon applied in the seed (grams per square metre)
        double seedC;
    ...
    public:
         ...
         */
        patchInterfaceClass(string       aName,
                            const int    aIndex,
                            const base * aOwner);
        ...
        // ! set value
        void SetReadyForHarvestOrLater(bool aVal) {
            ReadyForHarvestOrLater = aVal;
        }

        void SetIrrigationDemand(double aVal) {
            IrrigationDemand = aVal;
        }

        void SetNH3Emission(double aVal) {
            NH3Emission = aVal;
        }
        ...
        double GetdryMatterGrazed() {
            return dryMatterGrazed;
        }
        ...
        // ! retrieve value
        double GetamountSeedDM() {
            return amountSeedDM;
        }

        // ! set value
        void SetamountSeedDM(double aVal) {
            amountSeedDM = aVal;
        }
        ...
        // ! retrieve value
        double GettheFractionIncorporated() {
            return theFractionIncorporated;
        }
        ...
        // ! retrieve value
        double GetdecompType() {
            return decompType;
        }

        // ! retrieve value
        double GetdecompAmount() {
            return decompAmount;
        }

        // ! retrieve value
        double GetdecompNH4_N() {
            return decompNH4_N;
        }

        // ! retrieve value
        double GetdecompNO3_N() {
            return decompNO3_N;
        }

        // ! retrieve value
        double GetdecompOrg_N() {
            return decompOrg_N;
        }
        ...
        double GetdecompPercentDM() {
            return decompPercentDM;
        }

        // ! set value
        void SetdecompAmount(double aVal) {
            decompAmount = aVal;
        }

        // ! retrieve value
        double GettheNitrate() {
            return theNitrate;
        }

        // ! retrieve value
        double GettheAmmonium() {
            return theAmmonium;
        }
        ...
        // ! set value
        void SetharvestCode(int aVal) {
            harvestCode = aVal;
        }

        double GetNH3Emission() {
            return NH3Emission;
        }
         ...
         * param CarbonInSeed the carbon applied in the seed (grams per metre squared)
         */
         ...
         */
        plantItem * createHarvestProduct(string aName,
                                         double amountDM,
                                         double amountN,
                                         double amountC);
         ...
         */
        void SetHarvestProduct(plantItem * aProduct,
                               int         code);
         ...
         */
        void SetEcoStatus(int                       theReadyForHarvestOrLater,
         ...
         */
        void AllocateCrop(string crop_id,
                          string cropName);
