    ...
    base
{
    private:
        struct emission_sources {
            ...
            double NOEmission;
            string name;
        } houseEmission[20], storeEmission[20];
        ...
        bsTime *            stopTime;
        bsTime *            myTime;
        string           myInputDirectory, myOutputDirectory, myClimateDirectory, myClimateFileName, mybaseOutputDir;
    ...
    public:
        ...
        eventControl * getEeventControl() {
            return myEventControl;
        }
        ...
        int GetNumberOfHouses() {
            return theBuildings -> GettheStables() -> NumOfNodes();
        }
        ...
        void initialise_MMS(int    farmNo,
                            string orgPath);
        ...
        int GetNumberFields() {
            return myEventControl -> getCropRotation() -> GetFields() -> NumOfNodes();
        }

        // !Returns the name of the input directory
        string GetMyInputDirectory() {
            return myInputDirectory;
        }

        // !Returns the name of the output directory
        string GetMyOutputDirectory() {
            return myOutputDirectory;
        }

        // !Returns the name of the directory containing the climate file
        string GetMyClimateDirectory() {
            return myClimateDirectory;
        }

        // !Returns the name of the climate file
        string GetMyClimateFileName() {
            return myClimateFileName;
        }

        // !Not used?
        string GetMybaseOutputDir() {
            return mybaseOutputDir;
        }
         ...
         */
        bool GetMMSTillage(int      patchNo,
                           double * theType,
                           double * theDepth,
         ...
         */
        bool GetMMSAddOrganic(int      patchNo,
                              double * theType,
                              double * theamount,
                              double * theDepth,
                              double * theTotalN,
         ...
         * param theNO3N the nitrate nitrogen applied (kilograms per hectare)
         */
        bool GetMMSDoFertilisation(int      patchNo,
                                   double * theNH4N,
                                   double * theNO3N);
         ...
         */
        bool GetMMSDoSowing(int      patchNo,
                            double * theSeedCode,
                            double * theSeedDM,
                            double * theSeedN);
         ...
         */
        bool GetMMSDoHarvesting(int      patchNo,
