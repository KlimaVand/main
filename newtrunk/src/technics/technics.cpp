...
technics::technics(string       aName,
                   const int    aIndex,
                   const base * aOwner):
    base(aName,
         aIndex,
 ...
 */
void technics::Initialize(string opFileName,
...
void technics::CreateOperationList(string aFileName) {
    ...
    operationSection = "soilTreatTech";
    ...
    operationSection = "plantCareTech";
    ...
    operationSection = "animalFertTech";
    ...
    operationSection = "mineralFertTech";
...
void technics::CreateFarmList(string fileName) {
    ...
    techEquipSection = "selfPropelled";
    ...
    techEquipSection = "manureApplicator";
...
void technics::ExecuteFields(fieldOperationFields * aFieldOp) {
    ...
    aFieldOp -> CalcCost(operationList, techFarmList, mode, &oneCost, DoUpdate);
}
...
void technics::UpdateFieldLabour(double hours) {
    ...
    theOutput -> AddIndicator(economicIndicator, LabourPeriod, "hours", hours);
    theOutput -> AddIndicator(economicIndicator, "13.50 Labour, maintance and management", "hours",
                              0.15 * hours);    // 15%  maintance and management
