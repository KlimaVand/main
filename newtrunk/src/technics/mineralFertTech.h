    ...
    public fieldOperationTech
{
    ...
    private:
        ...
        mineralFertTech & operator = (
                const mineralFertTech & m);    // Dissable the compilers generation of default assignment operator.

    protected:
        virtual void CalcGangHours();

    public:
        mineralFertTech(string       aName,
                        const int    aIndex,
        ...
        void SetTheFertilizers(fertilizer * aFertilizer1,
