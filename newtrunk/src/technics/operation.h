    ...
    public base
{
    ...
    private:
        ...
        operation & operator = (
                const operation & o);      // Dissable the compilers generation of default assignment operator.
    ...
    protected:
        ...
        void SetaGang(gang * aaGang) {
            aGang = aaGang;
        }

        void CalcGangMaintenance();
    ...
    public:
        ...
        void SetoperationName(const string & aoperationName) {
