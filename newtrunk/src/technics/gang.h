    ...
    public base
{
    ...
    public:
        ...
        void SetgangElectricity(int agangElectricity) {
            gangElectricity = agangElectricity;
        }

        void SetgangHours(double agangHours) {
            gangHours = agangHours;
        }

        void SetgangMaintenance(double agangMaintenance) {
            gangMaintenance = agangMaintenance;
        }

        void SetgangFuel(double agangFuel) {
            gangFuel = agangFuel;
        }

        double GetgangMaintenance() {
            return gangMaintenance;
        }

        int GetgangElectricity() {
            return gangElectricity;
        }
        ...
        int Initialize(linkList<string> *    aStringList,
