    ...
    public product
{
    ...
    public:
        ...
        friend ostream & operator <<(ostream &          os,
                                     const fertilizer & afertilizer);

        void SetN_content(nitrogen aN_content) {
            N_content = aN_content;
        }

        void SetP_content(double aP_content) {
            P_content = aP_content;
        }

        void SetK_content(double aK_content) {
        ...
        void SetCl_content(double aCl_content) {
            Cl_content = aCl_content;
        }

        void SetMineralForm(string aMineralForm) {
            MineralForm = aMineralForm;
        }

        void SetNH4_fraction(double aFrac) {
            NH4_fraction = aFrac;
        }

        // Get functions
        nitrogen GetN_content(void) const {
            return N_content;
        }

        double GetP_content(void) const {
            return P_content;
        }

        double GetK_content(void) const {
            return K_content;
        }
        ...
        double GetCl_content(void) const {
            return Cl_content;
        }

        string GetMineralForm() const {
            return MineralForm;
        }

        double GetNH4_fraction() {
            return NH4_fraction;
        }
