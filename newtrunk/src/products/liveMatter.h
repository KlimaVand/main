    ...
    public product
{
    ...
    public:
        ...
        virtual void SetorgN_content(const nitrogen aorgN_content) {
            orgN_content = aorgN_content;
        }

        virtual void SetNH4_content(const nitrogen aNH4_content) {
            NH4_content = aNH4_content;
        }

        virtual void SetNO3_content(const nitrogen aNO3_content) {
            NO3_content = aNO3_content;
        }

        virtual void SetP_content(const double aP_content) {
            P_content = aP_content;
        }

        virtual void SetK_content(const double aK_content) {
            K_content = aK_content;
        }

        virtual void SetDryMatter(const double DM) {
            dryMatter = DM;
        }

        virtual void Setorganic(double aorganic) {
            organic = aorganic;
        }

        virtual void SetC_content(const double CC) {
            C_content = CC;
        }

        virtual void SetS_content(const double SC) {
            S_content = SC;
        }

        virtual void ClearOrgN_content() {
            orgN_content.Clear();
        }
        ...
        // Get functions
        virtual nitrogen GetorgN_content() const {
            return orgN_content;
        }

        virtual nitrogen GetNH4_content() const {
            return NH4_content;
        }

        virtual nitrogen GetNO3_content() const {
            return NO3_content;
        }

        virtual nitrogen GetTotalN() {
            return GetAllN();
        }

        virtual nitrogen GetAllN();

        virtual double GetTotalC() {
            return amount * C_content;
        }

        virtual double GetP_content() const {
            return P_content;
        }

        virtual double GetK_content() const {
            return K_content;
        }

        virtual double GetdryMatter() const {
            return dryMatter;
        }

        virtual double Getorganic(void) const {
            return organic;
        }

        virtual double GetC_content() const {
            return C_content;
        }

        virtual double GetS_content() const {
            return S_content;
        }
