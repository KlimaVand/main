    ...
    public liveMatter
{
    ...
    public:
        ...
        void SetCa_content(double aCa_content) {
            Ca_content = aCa_content;
        }

        void SetNa_content(double aNa_content) {
        ...
        void Setstarch(double astarch) {
            starch = astarch;
        }

        void Setchew(double achew) {
            chew = achew;
        }

        void Setaat(double aaat) {
            aat = aaat;
        }

        void Setpbv(double apbv) {
            pbv = apbv;
        }

        void Setcell(double acell) {
            cell = acell;
        }

        void Setfill(double afill) {
            fill = afill;
        }

        void SetfillU(double afillU) {
            fillU = afillU;
        }

        void SetMethionin(double aMethionin) {
            Methionin = aMethionin;
        }

        void SetThreonin(double aThreonin) {
            Threonin = aThreonin;
        }

        void SetLysin(double alysin) {
            Lysin = alysin;
        }

        void SetproteinN_digestibility(double aproteinN_digestibility) {
            proteinN_digestibility = aproteinN_digestibility;
        }

        void SetOMD(double aOMD) {
            OMD = aOMD;
        }

        void SetME(double anME) {
            ME = anME;
        }

        void SetfeedCategory(int aValue) {
            feedCategory = aValue;
        }

        // Get functions
        double GetOMD(void) const {
            return OMD;
        }

        double GetproteinN_digestibility(void) const {
            return proteinN_digestibility;
        }

        double GetfeedUnitsPerItemUnit(void) const {
            return feedUnitsPerItemUnit;
        }

        double GetCa_content(void) const {
            return Ca_content;
        }

        double GetNa_content(void) const {
            return Na_content;
        }
        ...
        double Getprotein_N(void) const {
        ...
        double Getsugar(void) const {
            return sugar;
        }

        double Getstarch(void) const {
            return starch;
        }

        double Getchew(void) const {
            return chew;
        }

        double Getaat(void) const {
            return aat;
        }

        double Getpbv(void) const {
            return pbv;
        }

        double Getcell(void) const {
            return cell;
        }

        double Getfill(void) const {
            return fill;
        }

        double GetfillU(void) const {
            return fillU;
        }

        double GetMethionin(void) const {
            return Methionin;
        }

        double GetThreonin(void) const {
            return Threonin;
        }

        double GetLysin(void) const {
            return Lysin;
        }
        ...
        double GetP_digest(void) const {
            return P_digest;
        }

        double GetMaxPercentage(void) const {
        ...
        double GetpigFeedUnitsPerItemUnit(void) const {
            return pigFeedUnitsPerItemUnit;
        }

        double GetPropRDP() const {
            return propRDP;
        }

        double GetmicroAAFactor() const {
            return microAAFactor;
        }

        double GetpropAAinUDP() const {
            return propAAinUDP;
        }

        double GetpropUDPdigestible() const {
            return propUDPdigestible;
        }

        double GetCHOContent() const {
            return CHO_content;
        }

        double GetpropDigestCHO() const {
            return propDigestCHO;
        }
        ...
        void AddPlantItem(const plantItem & somePlantItem,
                          int               feedCat);
