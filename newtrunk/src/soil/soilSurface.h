    ...
    public base
{
    ...
    public:
        ...
        void Initialize(string soilFileName);
        ...
        void AddSolidNitrogen(nitrogen addNitrate,
                              nitrogen addAmmonium);       // add N to surface (units: g-N/m2)

        void AddDisolvedNitrogen(nitrogen addNitrate,
                                 nitrogen addAmmonium);    // add N to surface (units: g-N/m2)
        ...
        organicProduct * RemoveProduct(int    No,
                                       double frac);
        ...
        nitrogen GetAmmoniaVolatilisation() {
            return ammoniaVolatilisation;
        }

        // Returns ammonia volatilisation [g N/m²]
        nitrogen GetAmmoniumSolid() {
            return ammoniumSolid;
        }

        double GetAmmoniumSolidN() {
            return ammoniumSolid.n;
        }

        double GetAmmoniumSolidN15() {
            return ammoniumSolid.n15;
        }

        // Returns ammonium nitrogen in the surface layer [g N/m²]
        nitrogen GetNitrateSolid() {
            return nitrateSolid;
        }

        double GetNitrateSolidN() {
            return nitrateSolid.n;
        }

        double GetNitrateSolidN15() {
            return nitrateSolid.n15;
        }

        // Returns nitrate nitrogen in the surface layer [g N/m²]
        void AddAmmoniumDissolved(nitrogen ad) {
            ammoniumDisolved = ammoniumDisolved + ad;
        }

        nitrogen GetAmmoniumDisolved() {
            return ammoniumDisolved;
        }

        double GetAmmoniumDisolvedN() {
            return ammoniumDisolved.n;
        }

        double GetAmmoniumDisolvedN15() {
            return ammoniumDisolved.n15;
        }

        // Returns disolved ammonium nitrogen in the surface layer [g N/m²]
        nitrogen ExtractAmmoniumDisolved();

        void AddNitrateDissolved(nitrogen nd) {
            nitrateDisolved = nitrateDisolved + nd;
        }

        nitrogen GetNitrateDisolved() {
            return nitrateDisolved;
        }

        double GetNitrateDisolvedN() {
            return nitrateDisolved.n;
        }

        double GetNitrateDisolvedN15() {
            return nitrateDisolved.n15;
        }
        ...
        void BeforeNitrateSolid() {
            BeforenitrateSolids = nitrateSolid.n;
        }

        double BeforenitrateDisolved;

        void BeforeNitrateDisolved() {
            BeforenitrateDisolved = nitrateDisolved.n;
        }
        ...
        void BeforeAmmoniumSolid() {
            beforeAmmoniumSolid = ammoniumSolid.n;
        }

        double beforeAmmoniumDisolved;

        void BeforeAmmoniumDisolved() {
            beforeAmmoniumDisolved = ammoniumDisolved.n;
        }
