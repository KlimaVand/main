 ...
 *
 * Class: animalStock
 * SuperClass of all animals stocks. This class should not be instantiated.
    ...
    public base
{
    ...
    private:
        animalStock & operator = (
                const animalStock & a);    // Dissable the compilers generation of default assignment operator.
    ...
    public:
        ...
        virtual void ReceivePlan(string fileExtension) {}
        ...
        virtual void dairyStockcheckBalances(bool show) {
            theMessage -> FatalError("animalStock::dairyStockcheckBalances- should only be call from dairyStock");
        }
};
#endif
