    ...
    public base
{
    ...
    public:
        ...
        product * GetProductPointer() const {
            return theProduct;
        }

        // !Set the pointer to the product stored
        void SetProductPointer(product * aProduct) {
            theProduct = aProduct;
        }
        ...
        // !Returns a pointer containing the amount of product requested from the store (or all that is available)
