    ...
    public manurestore
{
    ...
    public:
        ...
        void SetvelocityConstant(double aVal) {
            velocityConstant = aVal;
        }
         ...
         * param CH4Emission points to amount of CH4 that have emitted (kg/time period)
         */
        virtual void floorVolatize(double   airVelocity,
         ...
         * param CH4Emission points to amount of CH4 that have emitted (kg/time period)
         */
        virtual void inhouseVolatize(double   airVelocity,
                                     double   tempWaterEvap,
                                     double   temperature,
                                     double   duration,
                                     double * volatAmmonia,
