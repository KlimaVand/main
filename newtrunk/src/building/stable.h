    ...
    public building
{
    ...
    protected:
        stable() {
            ...
            standardSections      = nullptr;
            inhouseStores         = nullptr;
            minTemperature        = maxTemperature = Emissionfactor = wallArea = 0.0;
            ...
            inUse                 = false;
            NH3Emission           = N2OEmission = NOEmission = N2Emission = CO2Emission = CH4Emission = waterEvap = 0.0;
        }
    ...
    public:
         ...
         */
        animalSection * GetanimalSection(string name);
