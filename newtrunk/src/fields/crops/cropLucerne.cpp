 ...
 */
cropLucerne::cropLucerne(string       aName,
                         const int    aIndex,
                         const base * aOwner,
                         string       cropName):
    cropRyegrass(aName,
                 ...
                 cropName)
{
    ...
    data -> FindItem("NFixationThisDay", &NFixationThisDay);
    data -> FindItem("PowDM", &PowDM);
}
...
void cropLucerne::NitrogenAndTranspiration(nitrogen aNitrogenUptake,
