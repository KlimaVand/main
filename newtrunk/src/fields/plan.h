...
class plan {
    ...
    int                                       futureNum;
    bool                                      finished, irrigationIncluded, automaticIrrigation;
    ...
    public:
        ...
        void HandPlanOver(cloneList<fieldOperationFields> * OP,
                          string                            crop_id,
                          int                               futrNum);

        fieldOperationFields * ReturnOperation(int year,
                int                                month,
                int                                day,
                bool                               upddate);
        ...
        bool FirstOperationToday(int year,
                                 int month,
                                 int day);
