    ...
    public fieldOperationFields
{
    private:
        ...
        irrigateFields & operator = (
                const irrigateFields & f);    // Dissable the compilers generation of default assignment operator.
    ...
    public:
        ...
        virtual void DefineIrrigateFieldsOp(operationNames op,
                string                                     crop,
                string                                     cropNm,
                int                                        yr,
                int                                        mon,
