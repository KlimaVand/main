...
class manualLabourFields:
    public fieldOperationFields
{
    private:
        double hours;

        manualLabourFields & operator = (
                const manualLabourFields & f);    // Dissable the compilers generation of default assignment operator.
    ...
    public:
        ...
        void DefineManualLabourFieldsOp(operationNames op,
                                        string         crop,
                                        string         cropNm,
                                        int            yr,
                                        int            mon,
