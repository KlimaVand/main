    ...
    public fieldOperationFields
{
    private:
        ...
        mineralFertFields & operator = (
                const mineralFertFields & f);    // Dissable the compilers generation of default assignment operator.
    ...
    public:
        ...
        void DefineMineralFertFieldsOp(operationNames op,
                                       string         crop,
                                       string         cropNm,
                                       int            yr,
                                       int            mon,
        ...
        virtual fertilizer * GetFertilizer1() {
            return aFertilizer1;
        }

        virtual fertilizer * GetFertilizer2() {
            return aFertilizer2;
        }

        virtual fertilizer * GetFertilizer3() {
            return aFertilizer3;
        }
