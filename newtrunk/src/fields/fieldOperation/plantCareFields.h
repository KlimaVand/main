    ...
    public fieldOperationFields
{
    private:
        ...
        plantCareFields & operator = (
                const plantCareFields & f);    // Dissable the compilers generation of default assignment operator.
    ...
    public:
        ...
        void DefinePlantCareFieldsOp(operationNames op,
                                     string         crop,
                                     string         cropNm,
                                     int            yr,
                                     int            mon,
        ...
        chemical * Get1stChemical() {
            return aChemical1;
        }

        chemical * Get2ndChemical() {
            return aChemical2;
        }

        chemical * Get3rdChemical() {
            return aChemical3;
        }
