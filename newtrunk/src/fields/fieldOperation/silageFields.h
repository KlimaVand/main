    ...
    public fieldOperationFields
{
    private:
        ...
        silageFields & operator = (
                const silageFields & f);    // Dissable the compilers generation of default assignment operator.
    ...
    public:
        ...
        void DefinesilageFieldsOper(operationNames op,
                                    string         crop,
                                    string         cropNm,
                                    int            yr,
                                    int            mon,
        ...
        plantItem * GetPlantItem() {
            return plantItems[0];
        }

        void SetPlantItem(plantItem * newPlantItem) {
            plantItems[0] = newPlantItem;
        }
