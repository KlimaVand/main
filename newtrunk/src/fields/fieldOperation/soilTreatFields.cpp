...
bool soilTreatFields::CalcCost(linkList<operation> * aOperationList,
    ...
    if (!aOperationNode) {
        theMessage -> WarningWithDisplay("soilTreatFields::CalcCost - Operation ", operationNameList[op_id],
                                         " not found in list");
        ...
        soilTreatTech * soilTreatTechInstance = (soilTreatTech *) aOperationNode -> element;
        ...
        if (soilTreatTechInstance -> CreateGang(aTechFarmList)) {
            ...
            if (update) {
                ...
                theOutput -> AddIndicator(708, "07.08 Cost of machine contractors", "Dkr",
                                          -soilTreatTechInstance -> GetMachinePoolPrice() * area);
