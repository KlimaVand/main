...
class fieldOperationFields {
    protected:
        ...
        fieldOperationFields & operator = (
                const fieldOperationFields & f);    // Dissable the compilers generation of default assignment operator.
    ...
    public:
        ...
        virtual void DefineOp(operationNames op,
                              string         crop,
                              string         cropNm,
                              int            yr,
                              int            mon,
        ...
        // ! returning false
        virtual bool IsForageHarvestOp() {
            return false;
        }
        ...
        // ! returning false
        virtual bool IsIrrigationOp() {
            return false;
        }

        // ! returning false
        virtual bool AutomaticIrrigation() {
            return false;
        }

        virtual int GetYear() {
            return opTime -> GetYear();
        }

        virtual int GetMonth() {
            return opTime -> GetMonth();
        }

        virtual int GetDay() {
            return opTime -> GetDay();
        }
         ...
         */
        virtual void SetOperationId(int aVal) {
            op_id = operationNames(aVal);
        }
};
#endif
