...
#include "staticWrape.h"

staticWrape::staticWrape() {
    cropName = "WNRPE";
}

double staticWrape::PVstratFactor(int PV_strat) {
    double f = 1.00;
...
void staticWrape::SpecifiedPlan(fieldOrder * PP,
                                int          JB_NO,
                                string       crop_id) {
    staticCrop::SpecifiedPlan(PP, JB_NO, crop_id);

    if (PP -> GetNumOfHarvestDates() > 1) {
        theMessage -> Warning("static_wnrape::SpecifiedPlan - more than one harvest date specified");
    }
}

cloneList<fieldOperationFields> * staticWrape::MakeOpList(fieldOrder * PP,
        int                                                            JB_NO) {
    ...
    if (!PP -> GetAutomatic()) {
        ...
        if (PP -> GetSolidManure() > 0) {    // Spread solid manure
            ...
            FO -> DefineAnimalFertFieldsOp(SpreadingSolidManure, crop_id, cropName, PP -> GetStartYear(), 8, 10,
        ...
        if (FLUID_HUG_fall > 0) {    // Spread FLUID manure
            ...
            FO -> DefineAnimalFertFieldsOp(SpreadingLiquidManure, crop_id, cropName, PP -> GetStartYear(), 8, 10,
                                           PP -> GetArea(), 0, PP -> GetDistance(), aManure);
            AddOpList(FO);
        ...
        if ((FLUID_HUG_fall <= 0) && (PP -> GetN() > 0)) {    // Apply mineral fertilizer
            ...
            FO -> DefineMineralFertFieldsOp(MineralFertilizing, crop_id, cropName, PP -> GetStartYear(), 9, 1,
                                            PP -> GetArea(), 0, PP -> GetDistance(), aFertilizer, nullptr, nullptr);
        ...
        {    // Ploughing
            ...
            FO -> DefineOp(Ploughing, crop_id, cropName, PP -> GetStartYear(), 8, 11, PP -> GetArea(), 0,
                           PP -> GetDistance());
            AddOpList(FO);
        }
        {    // 1st seed bed harrowing
            ...
            FO -> DefineOp(SeedbedHarrowing, crop_id, cropName, PP -> GetStartYear(), 8, 12, PP -> GetArea(), 0,
                           PP -> GetDistance());
            AddOpList(FO);
        }
        ...
        if (JB_NO <= 4) {    // 2nd seed bed harrowing
            ...
            FO -> DefineOp(SeedbedHarrowing, crop_id, cropName, PP -> GetStartYear(), 8, 13, PP -> GetArea(), 0,
                           PP -> GetDistance());
            AddOpList(FO);
        }
        ...
        if (JB_NO <= 4) {    // 3. seed bed harrowing (only clayish soils)
            ...
            FO -> DefineOp(SeedbedHarrowing, crop_id, cropName, PP -> GetStartYear(), 8, 14, PP -> GetArea(), 0,
                           PP -> GetDistance());
            AddOpList(FO);
        }
        ...
        {                                                         // Sowing
            ...
            FO -> DefineSowFieldsOp(Sowing, crop_id, cropName, PP -> GetStartYear(), 8, 15, PP -> GetArea(), 0,
        ...
        if (PP -> GetPVStrat() == 2) {    // Spraying herbicide
            ...
            FO -> DefinePlantCareFieldsOp(Spraying, crop_id, cropName, PP -> GetStartYear(), 9, 15, PP -> GetArea(), 0,
        ...
        if (PP -> GetPVStrat() < 2) {    // Weedharrowing
            soilTreatFields * FO = new soilTreatFields;

            FO -> DefineOp(WeedHarrowing, crop_id, cropName, PP -> GetStartYear(), 9, 15, PP -> GetArea(), 0,
                           PP -> GetDistance());
            AddOpList(FO);
        }
        ...
        {    // Plantprotection registrations - hours for the entire fall
            ...
            FO -> DefineManualLabourFieldsOp(MonitoringCrop, crop_id, cropName, PP -> GetStartYear(), 10, 1,
                                             PP -> GetArea(), 0, PP -> GetDistance(), 0, 3);
            AddOpList(FO);
        }
        ...
        if ((FLUID_HUG_spring <= MaxGylle) && (PP -> GetSolidManure() <= 0)
            ...
            FO -> DefineMineralFertFieldsOp(MineralFertilizing, crop_id, cropName, PP -> GetStartYear() + 1, 3, 10,
        ...
        if (((FLUID_HUG_spring <= 0) && (PP -> GetSolidManure() > 0))
                && ((PP -> GetN() > 0) || (PP -> GetK() > 0) || (PP -> GetP() > 0))) {    // Apply mineral fertilizer
            double Napply = PP -> GetN();
            ...
            FO -> DefineMineralFertFieldsOp(MineralFertilizing, crop_id, cropName, PP -> GetStartYear() + 1, 4, 1,
                                            PP -> GetArea(), 0, PP -> GetDistance(), aFertilizer1, aFertilizer2,
                                            aFertilizer3);
        ...
        if ((fHUG > 0) && (PP -> GetSolidManure() > 0)) {    // Apply FLUID manure
            ...
            FO -> DefineAnimalFertFieldsOp(SpreadingLiquidManure, crop_id, cropName, PP -> GetStartYear() + 1, 4, 1,
                                           PP -> GetArea(), 0, PP -> GetDistance(), aManure);
        ...
        if ((N > 0) || (P > 0) || (K > 0)) {    // Apply mineral fertilizer - last time
            ...
            FO -> DefineMineralFertFieldsOp(MineralFertilizing, crop_id, cropName, PP -> GetStartYear() + 1, 4, 11,
                                            PP -> GetArea(), 0, PP -> GetDistance(), aFertilizer1, aFertilizer2,
                                            aFertilizer3);
        ...
        if ((N < vsm) || (N > vs) || (P < vsm) || (P > vs) || (K < vsm) || (K > vs) || (fHUG < vsm) || (fHUG > vs)) {
            theMessage -> WarningWithDisplay("static_wnrape::BasicOpList - Error in fertilizer handling.");
        }

        if (PP -> GetPVStrat() == 0) {    // Weedharrowing
            soilTreatFields * FO = new soilTreatFields;

            FO -> DefineOp(WeedHarrowing, crop_id, cropName, PP -> GetStartYear() + 1, 4, 12, PP -> GetArea(), 0,
                           PP -> GetDistance());
            AddOpList(FO);
        }

        if (PP -> GetPVStrat() > 0) {    // Spraying insecticide
            chemical * aChemical1 = new chemical;
            ...
            FO -> DefinePlantCareFieldsOp(Spraying, crop_id, cropName, PP -> GetStartYear() + 1, 6, 1, PP -> GetArea(),
                                          0, PP -> GetDistance(), aChemical1, nullptr, nullptr, aWater);
            AddOpList(FO);
        ...
        if ((JB_NO <= 4) && irrigation) {    // Irrigate 30 mm on sandy soils
            ...
            FO -> DefineIrrigateFieldsOp(Irrigating, crop_id, cropName, PP -> GetStartYear() + 1, 6, 10,
        ...
        if (PP -> GetPVStrat() > 1) {    // Spraying insecticide
            chemical * aChemical1 = new chemical;
        ...
        {    // Using harvester
            ...
            FO -> DefineHarvestFieldsOper(CombineHarvestingShred, crop_id, cropName, PP -> GetStartYear() + 1, 8, 2,
        ...
        {    // Stubharrowing
            ...
            FO -> DefineOp(StubHarrowing, crop_id, cropName, PP -> GetStartYear() + 1, 8, 17, PP -> GetArea(), 0,
                           PP -> GetDistance());
            AddOpList(FO);
        }
    }
...
double staticWrape::NitrogenAmount(int    JB_NO,
                                   double free_N,
                                   int    N_level) {
    double N = Nopt(JB_NO);
...
double staticWrape::Nopt(int JB_NO) {
...
double staticWrape::Ymin(int JB_NO) {
    if (JB_NO > 4) {    // Clayish soil
        return 2.0;
    } else {            // Sandy soil
        if (irrigation) {
...
double staticWrape::Ymax(int JB_NO) {
    if (JB_NO > 4) {    // Clayish soil
        return 4.0;
    } else {            // Sandy soil
        if (irrigation) {
...
double staticWrape::ExpectedYield_(int JB_NO,
                                   int N_level,
                                   int PV_strat) {
