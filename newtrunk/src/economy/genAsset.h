...
class GenAsset {
    ...
    public:
        ...
        void setNewValue(double aNewValue) {
            NewValue = aNewValue;
        }
        ...
        virtual void SetScalable(bool aVal) {
            scalable = aVal;
        }

        virtual double GetRefCapacity() {
            return RefCapacity;
        }

        virtual void SetActualCapacity(double aVal) {
            ActualCapacity = aVal;
        }

        virtual void initEconomy(commonData *& aBase);    // Initialization by the actual object
