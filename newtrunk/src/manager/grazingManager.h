...
public:
    ...
    double GetminHarvestable()
    {
        return minHarvestable;
    }

    bool GetenableGrazing()
    {
        return enableGrazing;
    }
    ...
    void ReceivePlan(commonData * data);    // , bsTime * turnout, bsTime * housing);
    ...
    double GetturnoutThreshold()
    {
        return turnoutThreshold;
    }

    int CalcGrazingPeriod(bsTime * aDate,
                          int      growthPeriod);

    void InsertCut(field * aField,
                   bool    harvestCut);

    double GetAverageGrowthRate(bsTime * aDate,
                                int      fieldNo,
                                int      duration);
    ...
    void SetGrazing(bsTime * aDate,
                    int      duration,
                    int *    numOthers);

    double GetExpectedGrowthRate(bsTime * aDate,
                                 int      fieldNo);
