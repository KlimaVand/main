...
void IndicatorOutput::InitializeIndicators()
{
   ...
   AddIndicator(economicIndicator,     "18.25 Exp. Grass ley yield (harv. bef. 1/8)","ha",0);
    AddIndicator(economicIndicator,"18.26 Exp. Dyerswoad yield (harv. bef. 1/8)","ha",0);
    AddIndicator(economicIndicator,"18.27 Exp. Triticale yield (harv. bef. 1/8)","ha",0);
    AddIndicator(economicIndicator,"18.28 Exp. FabaBean yield (harv. bef. 1/8)","ha",0);
     AddIndicator(economicIndicator,"18.29 Exp. CrimsonClover yield (harv. bef. 1/8)","ha",0);
