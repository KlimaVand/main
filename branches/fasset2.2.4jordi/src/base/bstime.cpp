...
{
	char * returns=new char[200];
   switch(dayInWeek)
   {
      case 1:
    	  strcpy(returns,"Monday");
      case 2:
    	  strcpy(returns,"Tuesday");
      case 3:
    	  strcpy(returns,"Wednesday");
      case 4:
    	  strcpy(returns,"Thursday");
      case 5:
    	  strcpy(returns,"Friday");
      case 6:
    	  strcpy(returns,"Saturday");
      case 7:
    	  strcpy(returns,"Sunday");
      default:
...
ostream& operator<< (ostream& os, const bsTime& aTime)
{
    ...
    os  << setw(2) << aTime.year<<setiosflags(ios::left);
   return os;
}
