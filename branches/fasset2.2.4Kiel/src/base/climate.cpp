...
{
   Circular = false;
   NitrogenInRain=theEnvironData->getNitrogenInRain();
  	DailyCO2Values = false;
   CO2Concentration = theEnvironData->getCO2Concentration();
   latitude = theEnvironData->getLatitude();                                         // Denmark
	int correct=theEnvironData->getPrecipitationCorrection();
   for (int i=0;i<13;i++)
