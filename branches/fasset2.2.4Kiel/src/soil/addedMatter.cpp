...
{
	//CK if(theTime.GetDay()==17&&theTime.GetMonth()==7&&theTime.GetYear()==2005)
	//CK 	{
	//CK
	//CK 		if(poolName=="AOM1")
	//CK 			cout<<carbon.c<<" poolName "<<endl;
	//CK }
   cnMatter outflux;
   cnMatter out;
   if (numOfSubPools>0)
...
void addedMatter::print(int current,int Last)
{
	static ofstream addedC;
		...
		string name =theSystemData->getOutputDirectory()+poolName+".xls";
		if(usedBefore==false)
		{
			usedBefore=true;
