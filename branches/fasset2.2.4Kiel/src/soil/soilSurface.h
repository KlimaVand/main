...
class soilSurface : public base
{
 ...
 string name=theSystemData->getOutputDirectory()+"AmmoniumSolidUsed.xls";
	if(AmmoniumSolidUsed==false)
	{

		AmmoniumSolidconent.open(name.c_str(),ios::out);
	...
	{
	AmmoniumSolidconent.open(name.c_str(),ios::app);
	AmmoniumSolidconent<<theTime<<"\t";
	}
 ...
 string name=theSystemData->getOutputDirectory()+"ammoniumDisolved.xls";
	if(ammoniumDisolvedUsed==false)
	{

		ammoniumDisolvedconent.open(name.c_str(),ios::out);
		ammoniumDisolvedconent<<theTime<<"\t";
		ammoniumDisolvedUsed=true;
	}
	else
	{
	ammoniumDisolvedconent.open(name.c_str(),ios::app);
	ammoniumDisolvedconent<<theTime<<"\t";
	}
 ...
 string name=theSystemData->getOutputDirectory()+"nitrateDisolved.xls";
	if(NitroDisolvedUsed==false)
	{

		NitrateDisolvedContent.open(name.c_str(),ios::out);
		NitrateDisolvedContent<<theTime<<"\t";
		NitroDisolvedUsed=true;
	}
	else
	{
	NitrateDisolvedContent.open(name.c_str(),ios::app);
	NitrateDisolvedContent<<theTime<<"\t";
	}
 ...
 string name=theSystemData->getOutputDirectory()+"NitrateSolid.xls";
	if(NitrateSolidUsed==false)
	{

		NitrateSolidContent.open(name.c_str(),ios::out);
	...
	{
	NitrateSolidContent.open(name.c_str(),ios::app);
	NitrateSolidContent<<theTime<<"\t";
	}
