...
int modified()
{
	...
	//      ScenarioFileName,
	 ...
	 //  bool SellPlantProducts=false;
	   ...
	   int index;
	 //CK  cout << "Farm ASSEsment Tool v2.2.3 test" << endl << endl;

	   cout << "v2.2.4Kiel" << endl << endl;
               ...
               ClimateFileName= theSystemData->getClimateFileName();
	            ...
	            for (int scenario=0; scenario<=NumberOfScenarios; scenario++)
	            {
	               ...
	               if (NumberOfScenarios>0)
	               {
	                  ...
	                  OutputDirectory1=OutputDirectory1+baseOutputDir+scenarioNumber+"\\";
	                  UseGams = 0;
	...
	//               chdir(OutputDirectory);
                  ...
                  char string80[80];
                   strcpy(string80, OutputDirectory1.c_str());
	               ...
	               aEventControl->Simulation(index, stopTime,UseGams,NumberOfFixedYears,GenerateFixedPlans,(char*)InputDirectory1.c_str(),(char*)OutputDirectory1.c_str(),(char*)ClimateDirectory.c_str(),
