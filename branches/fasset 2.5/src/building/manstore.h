...
public:
   ...
   // Constructor with arguments
	manurestore(const char *aName,const int aIndex,const base* aOwner,string manureType);
   // Copy constructor
   ...
   virtual bool Getexternal(){return external;}
   ...
   virtual int getmanureStoreID(){return manureStoreID;}
	...
	virtual double isInstore(){return false;}
};
