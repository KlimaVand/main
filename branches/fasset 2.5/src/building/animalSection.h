...
class animalSection:public base
{
protected:
...
public:
   ...
   animalSection(const char* aName,const int aIndex,const base* aOwner,commonData * &runData,commonData * &common, bool controlledVent);
   //! Destructor
   ...
   double GetPlaces() {return Places;};
   ...
   double GetminVentilation(){return minVentilation;}
   //! return maximum ventilation rate
   double GetmaxVentilation() {return maxVentilation;}
   ...
   //!Function for dynamically calculating ammonia volatilisation and other gaseous losses
	 ...
	 */
 virtual void Volatize(double airVelocity, double waterEvapThisSection, double temperature,
