...
void SendGrazed(double grazing_height, double DMGrazed, double NGrazed){theEcosystem->SetGrazed(grazing_height, DMGrazed);};   void outputCropDetails(fstream *afile) {theEcosystem->outputCropDetails(afile);};
