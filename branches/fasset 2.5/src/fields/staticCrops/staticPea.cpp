...
/****************************************************************************\
\****************************************************************************/
cloneList<fieldOperationFields> * staticPea::MakeOpList(fieldOrder * PP,int JB_NO)
{
...
//         FO->DefineOp(Ploughing,crop_id,cropName,PP->GetStartYear(),3,28,PP->GetArea(),0,PP->GetDistance());    Corrected MEL 2009
      ...
      { // Sowing
         ...
         FO->DefineSowFieldsOp(Sowing,crop_id,cropName,PP->GetStartYear()+1,4,1,PP->GetArea(),0,PP->GetDistance(),PP->GetPVStrat(),0,aSeed);
         AddOpList(FO);
         delete aSeed;
      }
      ...
      if (PP->GetPVStrat()>0) { // Spraying
         ...
         FO->DefinePlantCareFieldsOp(Spraying,crop_id,cropName,PP->GetStartYear()+1,4,15,PP->GetArea(),0,PP->GetDistance(),aChemical1,aChemical2,nullptr,aWater);
         AddOpList(FO);
         delete aChemical1;
         delete aChemical2;
         delete aWater;
      ...
      FO->DefineHarvestFieldsOper(CombineHarvestingShred,crop_id,cropName,PP->GetStartYear()+1,8,15,PP->GetArea(),0,PP->GetDistance(),0,false,PP->GetFractionStrawHarvested(0),PP->GetFractionGrainHarvested(0));
...
/****************************************************************************\
\****************************************************************************/
int staticPea::NumOfProtectStrat_()
{
	return 3;
}
...
/****************************************************************************\
\****************************************************************************/
double staticPea::PhosphorAmount_()
{
	return 25;
}
...
/****************************************************************************\
\****************************************************************************/
double staticPea::PotassiumAmount_()
{
	return 50;
}
...
/****************************************************************************\
\****************************************************************************/
double staticPea::ExtraNRelease_()
{
	return 35; // 35 - but not achievable with current C turnover model!
}
