...
/****************************************************************************\
\****************************************************************************/
cloneList<fieldOperationFields> * staticLucerneEstablished::MakeOpList(fieldOrder * PP,int JB_NO)
{
   ...
   { // Automatic plan - three cuts
...

      {
         ...
         FO->DefineHarvestFieldsOper(CutSetAside,crop_id,cropName,PP->GetStartYear()+1,6,20,PP->GetArea(),0,PP->GetDistance(),0,true);
      ...
      }
      {
         ...
         aPlantItem->Setamount(ExpectedYield_(JB_NO,PP->GetNLevel(),PP->GetPVStrat()));
         harvestFields * FO=new harvestFields;
         FO->DefineHarvestFieldsOper(CutSetAside,crop_id,cropName,PP->GetStartYear()+1,7,26,PP->GetArea(),0,PP->GetDistance(),0,true);
         FO->SetMainProduct(aPlantItem);
         AddOpList(FO);
         delete aPlantItem;
      }
      {
         ...
         aPlantItem->Setamount(ExpectedYield_(JB_NO,PP->GetNLevel(),PP->GetPVStrat()));
         harvestFields * FO=new harvestFields;
         FO->DefineHarvestFieldsOper(CutSetAside,crop_id,cropName,PP->GetStartYear()+1,9,12,PP->GetArea(),0,PP->GetDistance(),0,true);
         FO->SetMainProduct(aPlantItem);
         AddOpList(FO);
         delete aPlantItem;
      }
...
/****************************************************************************\
\****************************************************************************/
int staticLucerneEstablished::NumOfProtectStrat_()
{
	return 1;
}
...
/****************************************************************************\
\****************************************************************************/
int staticLucerneEstablished::NitrogenLevels_()
{
	return 1;
}
...
/****************************************************************************\
\****************************************************************************/
int staticLucerneEstablished::FallowCrop()
{
	return 1;
}
...
/****************************************************************************\
\****************************************************************************/
double staticLucerneEstablished::ExtraNRelease_()
{
	return 0.0;
}
