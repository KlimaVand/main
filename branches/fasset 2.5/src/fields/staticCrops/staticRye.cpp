...
/****************************************************************************\
\****************************************************************************/
cloneList<fieldOperationFields> * staticRye::MakeOpList(fieldOrder * PP,int JB_NO)
{
   ...
   */
   ...
   { // Automatic plan
      ...
      { // Sowing
         ...
         FO->DefineSowFieldsOp(Sowing,crop_id,cropName,PP->GetStartYear(),10,4,PP->GetArea(),0,PP->GetDistance(),PP->GetPVStrat(),0,aSeed);
         AddOpList(FO);
         delete aSeed;
      }
      ...
      if (PP->GetPVStrat()==2) { // Spraying herbicide
         ...
         FO->DefinePlantCareFieldsOp(Spraying,crop_id,cropName,PP->GetStartYear(),11,15,PP->GetArea(),0,PP->GetDistance(),aChemical1,aChemical2,nullptr,aWater);
         AddOpList(FO);
         delete aChemical1;
         delete aChemical2;
         delete aWater;
...
/****************************************************************************\
\****************************************************************************/
int staticRye::NumOfProtectStrat_()
{
...
/****************************************************************************\
\****************************************************************************/
double staticRye::PhosphorAmount_()
{
	return 25;
}
...
/****************************************************************************\
\****************************************************************************/
double staticRye::PotassiumAmount_()
{
	return 60;
}
...
/****************************************************************************\
\****************************************************************************/
double staticRye::ExtraNRelease_()
{
	return 0;
}
...
/****************************************************************************\
\****************************************************************************/
int staticRye::SlyrryPossibleThisPeriod(period * p)
{
