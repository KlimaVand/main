...
class manureApplic: public techEquip
{
   ...
   public:
      ...
      manureApplic(const char * aName, const int aIndex = -1, const base * aOwner = nullptr);
      // Copy Constructor
      ...
      double GetpropAreaWetted() {return propAreaWetted;};
      bool GetcropContamination() {return cropContamination;};
      double GetNH3emissionFactor() {return NH3emissionFactor;};
      void SetpropBuried(double aProp) {propBuried=aProp;};
};
