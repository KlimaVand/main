...
class matter : public base
{
   protected:
    ...
    public:
       ...
       virtual void SetDeathRate(double d) { theMessage[id]->FatalError("Can not set death-rate for this type of pool.");};
       virtual void SetMaintenanceRate(double m) { theMessage[id]->FatalError("Can not set mainatance-rate for this type of pool.");};
       virtual double GetDeathRate() { theMessage[id]->FatalError("Can not get death-rate for this type of pool.");return 0.0;};
       virtual double GetMaintenanceRate() { theMessage[id]->FatalError("Can not get mainatance-rate for this type of pool.");return 0.0;};
       ...
       virtual int GetPoolName(){return poolName;};
