...
void GenAsset::GiveEconomicIndicators()
{
   ...
   theOutput[id]->AddIndicator(702,"07.02 Depreciation buildings & inventory","Dkr",-getDepreciationValue());
   theOutput[id]->AddIndicator(704,"07.04 Insurance buildings & inventory","Dkr",-getInsuranceValue());
   theOutput[id]->AddIndicator(705,"07.05 Maintenance buildings & inventory","Dkr",-getMaintenanceValue());
   theOutput[id]->AddIndicator(302,"03.02 Value of buildings & inventory","Dkr",getTotalValue());
#endif
}
