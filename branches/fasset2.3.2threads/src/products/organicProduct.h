...
class organicProduct : public base
{
   ...
   public:
      ...
      int GetDestPool(int num){return allocationList[num].poolName;};
      ...
      nitrogen GetNitrate() {
    	  if (NO3.n<0.0||NO3.n15<0.0)
    	      theMessage[id]->FatalError("organicProduct::GetNitrate - negative amount of NO3");
    	  return NO3;};
      nitrogen GetAmmonium() {
    	  if (NH4.n<0.0||NH4.n15<0.0)
    	   theMessage[id]->FatalError("organicProduct::GetNitrate - negative amount of NH4");
    	  return NH4;};
