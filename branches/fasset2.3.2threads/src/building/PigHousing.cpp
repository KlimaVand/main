...
/*	theOutput[id]->AddIndicator("07.02 Labour, stable","hours",hours);
	theOutput[id]->AddIndicator("07.03 Labour, maintance and management","hours",0.20*hours);  // 5% for building maintance + 15% for management
	theOutput[id]->AddIndicator("07.04 Total labour","hours",hours*1.20);
                                                                                       */
}
