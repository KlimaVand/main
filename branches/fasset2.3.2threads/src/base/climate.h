...
public:
   ...
   climate(){file=NULL;filetyp = 0;EpotCalculationMethod = 0; found = false;};

   climate(int aType,int aMethod) {file=NULL;filetyp = aType; EpotCalculationMethod = aMethod;};
   ~climate();
