...
cropItalRyegrass::cropItalRyegrass(const char * aName, const int aIndex, const base * aOwner, string cropName)
                :cropSpringWheat(aName,aIndex,aOwner, cropName)
{
//theMessage[id]->FatalError("cropItalRyegrass:: this class has not been fully tested. Delete this line to test");
