...
public:
   ...
   */
   virtual void Cut(plantItem * cutPlantMaterial, double cut_height);
	...
	virtual void Grazing(double grazedDM){theMessage[id]->FatalError("crop::Grazing - this crop does not have a grazing function");};
...
//   virtual void CutPlant(double CuttingHeight,double& DM, double& N, double& digest) {};
   ...
   virtual void SetCropName(char * aName){CropName = aName;};
	virtual double GetAvailableDM(double residualDM){theMessage[id]->FatalError("Crop:;GetAvailableDM - this crop cannot be grazed"); return 0.0;}
	virtual double GetAvailableDigestibleDM(double residualDM){theMessage[id]->FatalError("Crop:;GetAvailableDigestibleDM - this crop cannot be grazed"); return 0.0;};
	virtual double GetAvailableN(double residualDM){theMessage[id]->FatalError("Crop:;GetAvailableN - this crop cannot be grazed"); return 0.0;};
};
