...
/****************************************************************************\
   Author   Lars Noboe Andersen & Poul Lassen
     Date
 Revision   Bj�rn Molt Petersen, May-November 1997
\****************************************************************************/
...
void operation::ReadParameters(commonData * &file)
{
  ...
  file->FindSection(Name,Index); // Top of hierarcy
   ...
   if (j<0)
      theMessage[id]->FatalError("operation::ReadOperationParameters - unknown operation/operation not found");
   operationNumber=j;
...
void operation::Update(linkList <techEquip> * aTechFarmList)
{
   ...
   UpdateProducts();
   theTechnics[id]->UpdateFieldLabour(aGang->GetgangHours());
