...
void technics::UpdateFieldLabour(double hours)
{
   ...
   theOutput->AddIndicator(1310,"13.10 Labour, field","hours",hours);

   string LabourPeriod = "13."+ (string) IndicatIndexString + " Field-labour " + (string) periodName;

   theOutput->AddIndicator(1300+IndicatIndex,(char*) LabourPeriod.c_str(),"hours",hours);
   theOutput->AddIndicator(1350,"13.50 Labour, maintance and management","hours",0.15*hours);  // 15%  maintance and management
	theOutput->AddIndicator(1301,"13.01 Total labour","hours",hours*1.15);
}
