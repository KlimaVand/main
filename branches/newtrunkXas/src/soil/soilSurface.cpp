...
void soilSurface::Initialize(char * soilFileName)
{
   commonData data;
...
{
	double TotalN = GetAmmoniumSolidN()+GetNitrateSolidN()+GetAmmoniumDisolvedN()+
   						GetNitrateDisolvedN()+GetOrganicNitrogenN();
   return TotalN;
}
double soilSurface::GetTotalNitrogenN15()
{
	double TotalN = GetAmmoniumSolidN15()+GetNitrateSolidN15()+GetAmmoniumDisolvedN15()+
   						GetNitrateDisolvedN15()+GetOrganicNitrogenN15();
   return TotalN;
}
...
int soilSurface::GetNumberOfProducts()
{
 ...
 static bool NitroDisolvedUsed=false;
	if(NitroDisolvedUsed==false)
	{
		...
		NitrateDisolvedContent.open(globalSettings->getOutputDirectory()+"nitrateDisolved.xls",ios::out);
		NitrateDisolvedContent<<theTime<<"\t";
		NitroDisolvedUsed=true;
	}
	else
	{
	NitrateDisolvedContent.open(globalSettings->getOutputDirectory()+"nitrateDisolved.xls",ios::app);
	NitrateDisolvedContent<<theTime<<"\t";
	}
 ...
 static bool NitrateSolidUsed=false;
	if(NitrateSolidUsed==false)
	{
		...
		NitrateSolidContent.open(globalSettings->getOutputDirectory()+"NitrateSolid.xls",ios::out);
	...
	{
	NitrateSolidContent.open(globalSettings->getOutputDirectory()+"NitrateSolid.xls",ios::app);
	NitrateSolidContent<<theTime<<"\t";
	}
 ...
 static bool AmmoniumSolidUsed=false;
	if(AmmoniumSolidUsed==false)
	{
		...
		AmmoniumSolidconent.open(globalSettings->getOutputDirectory()+"AmmoniumSolidUsed.xls",ios::out);
	...
	{
	AmmoniumSolidconent.open(globalSettings->getOutputDirectory()+"AmmoniumSolidUsed.xls",ios::app);
	AmmoniumSolidconent<<theTime<<"\t";
	}
 ...
 static bool ammoniumDisolvedUsed=false;
	if(ammoniumDisolvedUsed==false)
	{
		...
		ammoniumDisolvedconent.open(globalSettings->getOutputDirectory()+"ammoniumDisolved.xls",ios::out);
		ammoniumDisolvedconent<<theTime<<"\t";
		ammoniumDisolvedUsed=true;
	}
	else
	{
	ammoniumDisolvedconent.open(globalSettings->getOutputDirectory()+"ammoniumDisolved.xls",ios::app);
	ammoniumDisolvedconent<<theTime<<"\t";
	}
