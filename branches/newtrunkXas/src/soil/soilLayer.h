...
//public:
   soilLayer(const char * aName, const int aIndex = -1, const base * aOwner = nullptr);
   ...
   double       GetAmmoniumN(double startDepth,double thickness);
   double       GetAmmoniumN15(double startDepth,double thickness);
   nitrogen       GetNitrate(double startDepth,double thickness);
   double       GetNitrateN(double startDepth,double thickness);
   double       GetNitrateN15(double startDepth,double thickness);
   nitrogen       GetAmmonium() {return ammonium_mob+ammonium_imob;};
   double       GetAmmoniumN() {return ammonium_mob.n+ammonium_imob.n;};
   nitrogen       GetNitrate() {return nitrate_mob+nitrate_imob;};
   double       GetNitrateN() {return nitrate_mob.n+nitrate_imob.n;};
   ...
   double       GetOrganicNitrogenN() {return OrganicMatter->GetNitrogenN();};
   double       GetOrganicNitrogenN15() {return OrganicMatter->GetNitrogenN15();};
   nitrogen       GetOrganicNitrogen(double startDepth, double thickness);
   double       GetOrganicNitrogenN(double startDepth, double thickness);
   double       GetOrganicNitrogenN15(double startDepth, double thickness);
   nitrogen       GetPoolNitrogen(int Name) {return OrganicMatter->GetPoolNitrogen(Name);};

   double       GetPoolNitrogenN(int Name,double startDepth,double thickness);
   double       GetPoolNitrogenN15(int Name,double startDepth,double thickness);
   ...
   double         GetPoolCarbon(int Name,double startDepth,double thickness)
