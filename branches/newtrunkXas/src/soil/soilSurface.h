...
class soilSurface : public base
{
 ...
 ~soilSurface();
 // Destructor
 void Initialize(char *soilFileName);
 // Update functions
 ...
 double GetAmmoniumSolidN() {return ammoniumSolid.n;};
 double GetAmmoniumSolidN15() {return ammoniumSolid.n15;};
 // Returns ammonium nitrogen in the surface layer [g N/m²]
 nitrogen GetNitrateSolid() {return nitrateSolid;};
 double GetNitrateSolidN() {return nitrateSolid.n;};
 double GetNitrateSolidN15() {return nitrateSolid.n15;};
 ...
 double GetAmmoniumDisolvedN() {return ammoniumDisolved.n;};
 double GetAmmoniumDisolvedN15() {return ammoniumDisolved.n15;};
 ...
 double GetNitrateDisolvedN() {return nitrateDisolved.n;};
 double GetNitrateDisolvedN15() {return nitrateDisolved.n15;};
