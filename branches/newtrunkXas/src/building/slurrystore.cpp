...
/****************************************************************************\
 ...
 \****************************************************************************/
slurrystore::slurrystore(char *aName, const int aIndex, const base* aOwner,commonData *  &runData,commonData * &original) :
...
void slurrystore::DailyUpdate()
{
	...
	theOutput->AddIndicator(
			...
			N2OEmission * 1000.0);
	theOutput->AddIndicator(
			4543,"45.43 CO2-C volatilisation from manure storage", "kg C",
			CO2Emission * 1000.0);
	theOutput->AddIndicator(
			4544,"45.44 CH4-C volatilisation from manure storage", "kg C",
			CH4Emission * 1000.0);
...
void slurrystore::RcvManure(const manure* someManure)
{
	...
	theOutput->AddIndicator(1972, "19.72 Slurry produced", "t",
