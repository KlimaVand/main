...
//  Manure_manager_class *manure_manager;
  ...
  fstream *detailsFile;			//file for output of operational information
...
//user created functions
 ...
 void daily_update ()  ;
  void Initialize(livestock * atheLivestock, cropRotation * atheCropRotation, buildings * atheBuildings);
  void ReceivePlan(char *fileExtension, char *inputDir);
//  void GetStatus();
  //void InitialiseFileOutput();
void ShowOpsDetails(bool header);
