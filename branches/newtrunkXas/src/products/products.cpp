...
strcpy(productSection,"premium");
   ...
   for(index=first;index<(first+num);index++)
   {
      ...
      premiumInstance->ReadParameters(runData,productSection);
       ...
       if(name.compare(premiumInstance->GetName())!=0)
             {
           	  string error="premium "+conve.IntToString(index)+" does not have the same names in the 2 files";
           	  theMessage->FatalError(error);
             }
		...
		case animalObj: income=((aProduct->GetAmount())*(aPrice->GetactualSellPrice()) );
                              ...
                              ||(strcmp(nameStr,"SOWS")==0)||(strcmp(nameStr,"NEWSOWS")==0))
                     {
                          ...
                          if (strcmp(nameStr,"SUCKLINGPIG")==0)
                        {
                        	 ...
                        	 theOutput->AddIndicator(1905,"19.05 Sold weaners","no",((animalProduct*)aProduct)->GetNumber());
                        }
                          if (strcmp(nameStr,"PIGLETS")==0)
                        {
                        	   theOutput->AddIndicator(532,"05.32 Piglets sold","Dkr",income);
                        	 theOutput->AddIndicator(1906,"19.06 Sold piglets","no",((animalProduct*)aProduct)->GetNumber());
                        }
                         if (strcmp(nameStr,"BACONERS")==0)
                        {
                        	  theOutput->AddIndicator(531,"05.31 Baconers sold","Dkr",income);
                        	  theOutput->AddIndicator(1907,"19.07 Sold baconers","no",((animalProduct*)aProduct)->GetNumber());
                        }
                          	if (strcmp(nameStr,"NEWSOWS")==0)
                        {
                        	   theOutput->AddIndicator(530,"05.30 Sows sold","Dkr",income);
                        	  theOutput->AddIndicator(1908,"19.08 Sold new sows","no",((animalProduct*)aProduct)->GetNumber());
                        }
                          if (strcmp(nameStr,"SOWS")==0)
                        {
                        	    theOutput->AddIndicator(533,"05.33 Cast sows sold","Dkr",income);
                        	   theOutput->AddIndicator(1909,"19.09 Sold cast sows","no",((animalProduct*)aProduct)->GetNumber());
                        }
                          ...
                          ||(strcmp(nameStr,"CALF")==0))
                     {
                           ...
                           if ((strcmp(nameStr,"HEIFERS1")==0)||(strcmp(nameStr,"HEIFERS2")==0))
                        {
                        	       ...
                        	       theOutput->AddIndicator(1935,"19.35 Sold 1st year heifers","no",((animalProduct*)aProduct)->GetNumber());
                        }
                          if (strcmp(nameStr,"HEIFERS3")==0)
                        {
                        	       theOutput->AddIndicator(551,"05.51 Young 2nd year heifers sold","Dkr",income);
                        	      theOutput->AddIndicator(1936,"19.36 Sold 2nd year heifers","no",((animalProduct*)aProduct)->GetNumber());
                        }
                          if (strcmp(nameStr,"DAIRY")==0)
                        {
                        	     theOutput->AddIndicator(552,"05.52 Dairy cattle sold","Dkr",income);
                        	    theOutput->AddIndicator(1937,"19.37 Sold dairy cattle","no",((animalProduct*)aProduct)->GetNumber());
                        }
                         if (strcmp(nameStr,"CALVES")==0)
                        {
                        	     theOutput->AddIndicator(553,"05.53 Beef cattle calves sold","Dkr",income);
                        	     theOutput->AddIndicator(1938,"19.38 Sold beef calves","no",((animalProduct*)aProduct)->GetNumber());
                        }
                             ...
                             ||(strcmp(nameStr,"CALF")==0))
                           {
                               theOutput->AddIndicator(554,"05.54 Mature beef cattle sold","Dkr",income);
                                   theOutput->AddIndicator(1939,"19.39 Sold beef cattle","no",((animalProduct*)aProduct)->GetNumber());
                           }
...
void products::SellPlantItem(product *itemToSell)
{
 ...
 //  char* indstr;
   ...
   if (amountStored>0.0)
   {
      ...
      {
    	  theMessage->Warning("products::SellPlantItem: trying to sell more than there are stored. Lower the amount.");
      ...
      theOutput->AddIndicator(3501,"45.01 C from imported feed","kg",kgTotalC);
#endif
      	if (aPlantItem->GetaPrice()!=nullptr)
        {
		...
		if (pname.compare("WNWHT")==0)  theOutput->AddIndicator(511,"05.11 W.wheat sold","Dkr",income);
		if (pname.compare("SPWHT")==0)  theOutput->AddIndicator(512,"05.12 S.wheat sold","Dkr",income);
		if (pname.compare("WNRPE")==0)  theOutput->AddIndicator(513,"05.13 W.rape sold","Dkr",income);
		if (pname.compare("SPRAPE")==0)  theOutput->AddIndicator(51,"05.14 S.rape sold","Dkr",income);
		if (pname.compare("WNBRL")==0)  theOutput->AddIndicator(515,"05.15 W.barley sold","Dkr",income);
		if (pname.compare("BARLEY")==0) theOutput->AddIndicator(516,"05.16 S.barley sold","Dkr",income);
		if (pname.compare("RYE")==0)    theOutput->AddIndicator(517,"05.17 Rye sold","Dkr",income);
		if (pname.compare("OAT")==0)    theOutput->AddIndicator(518,"05.18 Oat sold","Dkr",income);
		if (pname.compare("PEA")==0)    theOutput->AddIndicator(519,"05.19 Pea sold","Dkr",income);
		if (pname.compare("POTATO")==0) theOutput->AddIndicator(520,"05.20 Potato sold","Dkr",income);
		if (pname.compare("WNWHT")==0)  theOutput->AddIndicator(521,"05.21 Grass for seed sold","Dkr",income);
		if (pname.compare("MAIZE")==0)  theOutput->AddIndicator(522,"05.22 Maize sold","Dkr",income);
		if (pname.compare("BEET")==0)   theOutput->AddIndicator(523,"05.23 Beet sold","Dkr",income);
		if (pname.compare("STRAW")>0)   theOutput->AddIndicator(524,"05.24 Straw sold","DKr",income);
   ...
   if (imported>0.0)
   {
	   ...
	   if (aProduct->GetObjType()==manureObj)
      {
   	...
   	double NImported=0.0, CImported=0.0;
   	 ...
   	 if (importedProduct->GetaPrice()!=nullptr)
...
// should be straw registered here                              theOutput->AddIndicator("10.20 Imported manure","t",importedProduct->GetAmount());
         ...
         case animalObj     : if ((strcmp(nameStr,"SUCKLINGPIG")==0)||(strcmp(nameStr,"PIGLETS")==0)||(strcmp(nameStr,"BACONERS")==0)
	         										...
	         										if (strcmp(nameStr,"SUCKLINGPIG")==0)
                                 {
	         									...
	         									indicatValue=628;
	         									   theOutput->AddIndicator(1902,"19.02 Bought weaners","no",((animalProduct*)aProduct)->GetNumber());
                                 }
                                 		if (strcmp(nameStr,"PIGLETS")==0)
                                 {
                                	 strcpy(indstr,  "06.29 Piglets bought");
                                	 indicatValue=629;
                                	 		   theOutput->AddIndicator(1903,"19.03 Bought piglets","no",((animalProduct*)aProduct)->GetNumber());
                                 }
                                   if (strcmp(nameStr,"BACONERS")==0)
                                 {
                                	  	strcpy(indstr,"06.30 Baconers bought");
                                	 	indicatValue=630;
                                 				   theOutput->AddIndicator(1904,"19.04 Bought baconers","no",((animalProduct*)aProduct)->GetNumber());
                                 }
                                  if ((strcmp(nameStr,"SOWS")==0)||(strcmp(nameStr,"NEWSOWS")==0))
                                 {
                                	  strcpy(indstr,"06.31 Sows bought");
                                	  indicatValue=631;
                                	     theOutput->AddIndicator(1901,"19.01 Bought sows","no",((animalProduct*)aProduct)->GetNumber());
                                 }
                              }
										if ((strcmp(nameStr,"HEIFERS1")==0)||(strcmp(nameStr,"HEIFERS2")==0)||(strcmp(nameStr,"HEIFERS3")==0)||(strcmp(nameStr,"DAIRY")==0)
										     || (strcmp(nameStr,"FBEEF1")==0)||(strcmp(nameStr,"FBEEF2")==0)||(strcmp(nameStr,"FBEEF3")==0)||(strcmp(nameStr,"SUCKLER")==0)||
                                 		(strcmp(nameStr,"MBEEF1")==0)||(strcmp(nameStr,"MBEEF2")==0)||(strcmp(nameStr,"MBEEF3")==0))
                              {
         								 ...
         								 if ((strcmp(nameStr,"HEIFERS1")==0) || (strcmp(nameStr,"HEIFERS2")==0))
                                 {
         									   ...
         									   indicatValue=650;
         									   theOutput->AddIndicator(1930,"19.30 Bought 1st year heifers","no",((animalProduct*)aProduct)->GetNumber());
                                 }
                                  if (strcmp(nameStr,"HEIFERS3")==0)
                                 {
                                	  strcpy(indstr,"06.51 Young 2nd year heifers bought");
                                	  indicatValue=651;
	                                  theOutput->AddIndicator(1931,"19.31 Bought 2nd year heifers","no",((animalProduct*)aProduct)->GetNumber());
                                 }
                                  if (strcmp(nameStr,"DAIRY")==0)
                              	{
                              		    strcpy(indstr,"06.52 Dairy cattle bought");
                              		    indicatValue=652;
                              		   theOutput->AddIndicator(1932,"19.32 Bought dairy cattle","no",((animalProduct*)aProduct)->GetNumber());
                                 }
                              	 if ((strcmp(nameStr,"FBEEF1")==0)||(strcmp(nameStr,"FBEEF2")==0)||(strcmp(nameStr,"FBEEF3")==0)||
                              	 		(strcmp(nameStr,"MBEEF1")==0)||(strcmp(nameStr,"MBEEF2")==0)||(strcmp(nameStr,"MBEEF3")==0))
                                 {
                                	     ...
                                	     indicatValue=654;
                                	    theOutput->AddIndicator(1933,"19.33 Bought beef calves","no",((animalProduct*)aProduct)->GetNumber());
                                 }
                                 if (strcmp(nameStr,"SUCKLER")==0)
                                 {
                                	    strcpy(indstr,"06.55 Mature beef cattle bought");
                                	    indicatValue=655;
                                	  theOutput->AddIndicator(1934,"19.34 Bought beef cattle","no",((animalProduct*)aProduct)->GetNumber());
                                 }
                              }
                              break;
...
product* products::GetProductPtr(string aProductName, bool isManure)
{
	...
	if(isManure==true)
	{
		...
		while (aProductNode!=nullptr && !found)
	   {
...
price* products::GetPricePtr(string aPriceName)
{
	...
	while (aPriceNode!=nullptr && !found)
	{
...
void products::ExistsPrice(price* somePrice)
{
   ...
   while (aPriceNode!=nullptr && !found)
   {
		...
		{
		found=true;
			theMessage->FatalError("products::ExistsPrice - Object <",(char*)(somePrice->GetName()), "> exists allready as a reference");
      }
      if ( (aPrice->GetName())==(somePrice->GetName()))
      {
      	found=true;
			theMessage->FatalError("products::ExistsPrice - Object named <",(char*)(somePrice->GetName()), "> exists allready");
      }
      aPriceNode=aPriceNode->next;
   }
}
...
void products::ExistsManure(manure* someProduct)
{
	...
	while (aProductNode!=nullptr && !found)
   {
		...
		if (someProduct==aProduct)
			theMessage->FatalError("products::ExistsProduct - Product <",(char*)(someProduct->GetName()), "> exists Allready as a reference");
		else if ((aProduct->GetName())==(someProduct->GetName()))
   			theMessage->FatalError("products::ExistsProduct - Product <",(char*)(someProduct->GetName()), "> exists Allready with the same name");
      aProductNode=aProductNode->next;
	}
}
/**
...
int products::GetHarvestProductCode(linkList<plantItem>* HarvestList)
{
   ...
   {
      plantItem *HarvestItem = HarvestList->ElementAtNumber(i);
      if (HarvestItem==nullptr)
         theMessage->FatalError("products::GetHarvestProductCode - about to call an object with a nullptr pointer");
