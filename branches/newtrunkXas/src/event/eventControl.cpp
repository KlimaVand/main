...
double MinFieldArea=0;
   ...
   if(WithoutFields==false)
		theCropRotation->Initialize(WithoutFields,Irrigation,daysBetweenIrrigation,irrigationDelay, FingerFlow,MinFieldArea);
...
//enable for debugging
   if((theTime.GetDay()==14) && (theTime.GetMonth()==1) && (theTime.GetYear()==1989))
   {
   	cout << "Break at dateline" << endl;
	cout << theTime.GetDay() << "." << theTime.GetMonth() << endl;
   }
