...
{
 double ret_val = -119.0 + 1.06*StephanBoltzmann*pow(skyTemp,4);
 return ret_val;
}
...
{
	double ret_val=-0.0000614342*pow(temperature,3)+0.00158927*pow(temperature,2)-2.36418*temperature+2500.79;
	return ret_val;
}
