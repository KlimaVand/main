...
class climate: public base
{
   ...
   int GetnumPrecipDays(){return numPrecipDays;}
...
public:
	...
	int numPrecipDays;
   climate(){file=nullptr;filetyp = 0;EpotCalculationMethod = 0; found = false;};

   climate(int aType,int aMethod) {file=nullptr;filetyp = aType; EpotCalculationMethod = aMethod;};
   ~climate();
