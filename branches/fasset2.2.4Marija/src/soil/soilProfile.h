...
void				WriteCarbon(const char * Name,bool usedBefores);
void				WriteN(const char * Name,bool usedBefores);
void 				WriteCN(const char * Name,bool usedBefores);
 ...
 void            EndBudget();
 void			WriteC();
 void	WriteDecompositionRate(const char * Name,bool usedBefores);
};
