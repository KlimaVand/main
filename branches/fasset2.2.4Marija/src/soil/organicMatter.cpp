...
{
	if(theTime.GetDay()==19&&theTime.GetMonth()==4&&theTime.GetYear()==2005)
		cout<<GetPoolCarbon("AOM1")<<" at 19/4-2005"<<endl;
	if(theTime.GetDay()==15&&theTime.GetMonth()==7&&theTime.GetYear()==2005)
		cout<<GetPoolCarbon("AOM1")<<" at 26/4-2005"<<endl;
   if (nitrate->n<-1E-9)
...
// Decompose ----------------------------------------------------------------
   ...
   for(int j=0;j<numberOfPools;j++)
	...
	if(theTime.GetDay()==15&&theTime.GetMonth()==7&&theTime.GetYear()==2005)
		cout<<GetPoolCarbon("AOM1")<<" at 26/4-2005"<<endl;   // 3. Calculate the total potential immobilisation and the available N
   double Nimob=0.0;
   for(int j=0;j<numberOfPools;j++)
   {
   ...
   for(int j=0;j<numberOfPools;j++)
   {
	   if(tmp==633178)
	   	if(theTime.GetDay()==15&&theTime.GetMonth()==7&&theTime.GetYear()==2005)
		cout<<GetPoolCarbon("AOM1")<<" at 26/4-2005 " <<tmp<<endl;
...
void organicMatter::print(int layer,int NumOfSoilLayers)
{
	...
	if(usedBeforeinPrint==false)
	{
		...
		NO3conent.open(theSystemData->getOutputDirectory()+"NO3conent.xls",ios::out);
		NH4conent.open(theSystemData->getOutputDirectory()+"NH4conent.xls",ios::out);
		NH4allwaysLeftconent.open(theSystemData->getOutputDirectory()+"NH4allwaysLeftconent.xls",ios::out);
	...
	else
	{
		...
		NO3conent.open(theSystemData->getOutputDirectory()+"NO3conent.xls",ios::app);
		NH4conent.open(theSystemData->getOutputDirectory()+"NH4conent.xls",ios::app);
		NH4allwaysLeftconent.open(theSystemData->getOutputDirectory()+"NH4allwaysLeftconent.xls",ios::app);
	}
