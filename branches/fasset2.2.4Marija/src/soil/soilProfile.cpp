...
static bool usedBefore=false;
	...
	{
		usedBefore=true;
		Cconent.open(theSystemData->getOutputDirectory()+"Ccontent.xls",ios::out);
			Cconent<<theTime<<"\t";
		 while (current != NULL)
		 {
			  double Content = 0;
	...
	{
	Cconent.open(theSystemData->getOutputDirectory()+"Ccontent.xls",ios::app);
	Cconent<<theTime<<"\t";
	}
...
void soilProfile::WriteCarbon(const char * Name,bool usedBefores)
{
 ...
 static ofstream Cconent;
	...
	if(usedBefores==false)
	{
		...
		Cconent.open(theSystemData->getOutputDirectory()+Name+"_C.xls",ios::out);
			Cconent<<theTime<<"\t";
		 while (current != NULL)
		 {
			  double Content = 0;
	...
	{
	Cconent.open(theSystemData->getOutputDirectory()+Name+"_C.xls",ios::app);
	Cconent<<theTime<<"\t";
	}
...
void soilProfile::WriteN(const char * Name,bool usedBefores)
{
 ...
 static ofstream Cconent;
	...
	if(usedBefores==false)
	{
		...
		Cconent.open(theSystemData->getOutputDirectory()+Name+"_N.xls",ios::out);
			Cconent<<theTime<<"\t";
		 while (current != NULL)
		 {
			  double Content = 0;
	...
	{
	Cconent.open(theSystemData->getOutputDirectory()+Name+"_N.xls",ios::app);
	Cconent<<theTime<<"\t";
	}
...
void soilProfile::WriteDecompositionRate(const char * Name,bool usedBefores)
{
 ...
 static ofstream Cconent;
	...
	if(usedBefores==false)
	{
		...
		Cconent.open(theSystemData->getOutputDirectory()+Name+"_DecompositionRate.xls",ios::out);
			Cconent<<theTime<<"\t";
		 while (current != NULL)
		 {
			  double Content = 0;
	...
	{
	Cconent.open(theSystemData->getOutputDirectory()+Name+"_DecompositionRate.xls",ios::app);
	Cconent<<theTime<<"\t";
	}
...
void soilProfile::WriteCN(const char * Name,bool usedBefores)
{
 ...
 static ofstream Cconent;
	...
	if(usedBefores==false)
	{
		...
		Cconent.open(theSystemData->getOutputDirectory()+Name+"_CN.xls",ios::out);
			Cconent<<theTime<<"\t";
		 while (current != NULL)
		 {
			  double Content = 0;
	...
	{
	Cconent.open(theSystemData->getOutputDirectory()+Name+"_CN.xls",ios::app);
	Cconent<<theTime<<"\t";
	}
