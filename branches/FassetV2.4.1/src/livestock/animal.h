...
public:
  ...
  virtual ~ animal ( ); //Destructor
   ...
   #ifndef _STANDALONE
   virtual void SetanimalSection (animalSection* aanimalSection){ theanimalSection = aanimalSection;}
   virtual animalSection* GetanimalSection () { return theanimalSection;}
   #endif
