          ...
          :crop(aName,aIndex,aOwner)
{
   ...
   GerminationConversion	= 1.2;        // Conversion factor seed DM -> plant DM
	FillFactor 					= 0.4;                // Guestimate - Fraction of net production after anthesis that goes into grain
   StoreForFilling 			= 0.2;          // Guestimate - Fraction of DM present at initiation of grain filling that is translocated to grain
