...
void ecosystem::GiveIndicators()
{
   ...
   theOutput->AddStateIndicator(environmentalIndicator,"32.60 Organic N in soil","kg N",(aSoil->GetTotalNitrogen(0,balanceDepth)-aSoil->GetMinNitrogen(0,balanceDepth))*area*10);
	...
	theOutput->AddStateIndicator(environmentalIndicator,"32.75 Organic N in soil 75-100 cm","kg N",(aSoil->GetTotalNitrogen(750,250)-aSoil->GetMinNitrogen(750,1750))*area*10);
	theOutput->AddStateIndicator(environmentalIndicator,"32.76 Mineral N in soil 75-100 cm","kg N",aSoil->GetMinNitrogen(750,250)*area*10);
