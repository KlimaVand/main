...
public class GlobalVars
{
    ...
    public struct zoneSpecificData
    {
        ...
        public struct C_ToolData
        {
            ...
            public double extensiveFactor;
            public double intensiveFactor;
        }
        ...
        public void readZoneSpecificData(int zone_nr, int currentFarmType)
        {
            ...
            for (int j = minSoil; j <= maxSoil; j++)
            {
                ...
                for (int k = minHistory; k <= maxHistory; k++)
                {
                    ...
                    RecipientPath = RecipientStub + "intensiveFactor(-1)";
                    newC_ToolData.intensiveFactor = AEZParamFile.getItemDouble("Value", RecipientPath);
                    RecipientPath = RecipientStub + "extensiveFactor(-1)";
                    newC_ToolData.extensiveFactor = AEZParamFile.getItemDouble("Value", RecipientPath);
