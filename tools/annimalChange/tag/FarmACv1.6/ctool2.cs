...
public class ctool2
{
     ...
     * @param errorFileName
     */
    public void Initialisation(double ClayFraction, double offsetIn, double amplitudeIn, double maxSoilDepthIn, double dampingDepthIn,
        ...
        ref double residualMineralN)
    {
        ...
        if ((GlobalVars.Instance.reuseCtoolData != -1)&&(NonBaselinespinupYears==0))
        {
            ...
            {
                GlobalVars.Instance.Error("could not find " + GlobalVars.Instance.getReadHandOverData());
            }
            string[] data = lines[0].Split('\t');
        
            fomc[0] = Convert.ToDouble(data[0]);
            fomc[1] = Convert.ToDouble(data[1]);
            humc[0] = Convert.ToDouble(data[2]);
            humc[1] = Convert.ToDouble(data[3]);
            romc[0] = Convert.ToDouble(data[4]);
            romc[1] = Convert.ToDouble(data[5]);
            FOMn = Convert.ToDouble(data[6]);
            residualMineralN = Convert.ToDouble(data[7]);
        ...
        ref double Cleached, ref double Nmin, ref double Nleached)
    {
        ...
        if ((GlobalVars.Instance.Ctoolheader == false)&&(writeOutput))
        {
            ...
            GlobalVars.Instance.writeCtoolFile("FOMCStoredStart", "Initial C FOM", "kgC/ha", GetFOMCStored().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("HUMCStoredStart", "Initial C HUM", "kgC/ha", GetHUMCStored().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("ROMCStoredStart", "Initial C ROM", "kgC/ha", GetROMCStored().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("FOMnStoredStart", "Initial N FOM", "kgN/ha", GetFOMn().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("HUMnStoredStart", "Initial N HUM", "kgN/ha", GetHUMn().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("ROMnStoredStart", "Initial N ROM", "kgN/ha", GetROMn().ToString(), parens, 0);
            ...
            GlobalVars.Instance.writeCtoolFile("FOMCStoredEnd", "Final_C_FOM", "kgC/ha", GetFOMCStored().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("HUMCStoredEnd", "Final_C_HUM", "kgC/ha", GetHUMCStored().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("ROMCStoredEnd", "Final_C_ROM", "kgC/ha", GetROMCStored().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("SoilOrganicCarbon=soc", "Final_C_Total", "kgC/ha", GetCStored().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("FOMnStoredEnd", "Final_N_FOM", "kgN/ha", GetFOMn().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("HUMnStoredEnd", "Final_N_HUM", "kgN/ha", GetHUMn().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("ROMnStoredEnd", "Final_N_ROM", "kgN/ha", GetROMn().ToString(), parens, 0);
            GlobalVars.Instance.writeCtoolFile("finalN til SoilOrganicNitrogen=son", "Final_N_Total", "kgN/ha", 0.ToString(), parens, 0);
        ...
        if (writeOutput)
        {
          //  GlobalVars.Instance.writerCtool;
            ...
            ctoolData.Add(GlobalVars.Instance.writeCtoolFile("GetFOMCStored", "Initial C FOM", "kgC/ha", GetFOMCStored().ToString(), parens, 0));
            ctoolData.Add(GlobalVars.Instance.writeCtoolFile("GetHUMCStored", "Initial C HUM", "kgC/ha", GetHUMCStored().ToString(), parens, 0));
            ctoolData.Add(GlobalVars.Instance.writeCtoolFile("GetROMCStored", "Initial C ROM", "kgC/ha", GetROMCStored().ToString(), parens, 0));
            ctoolData.Add(GlobalVars.Instance.writeCtoolFile("GetFOMn", "Initial N FOM", "kgN/ha", GetFOMn().ToString(), parens, 0));
            ctoolData.Add(GlobalVars.Instance.writeCtoolFile("GetHUMn", "Initial N HUM", "kgN/ha", GetHUMn().ToString(), parens, 0));
            ctoolData.Add(GlobalVars.Instance.writeCtoolFile("GetROMn", "Initial N ROM", "kgN/ha", GetROMn().ToString(), parens, 0));
        }
