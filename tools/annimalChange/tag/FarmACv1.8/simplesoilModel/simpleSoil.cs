    ...
    class simpleSoil
    {
        ...
        */
            ...
            double [] layerOrgC)
        {
            ...
            {
                string soiltypeName = GlobalVars.Instance.theZoneData.thesoilData[soiltypeNo].Getname();
                string errorString = "Maximum rooting depth is greater than soil depth for crop " + cropName + " on soil " + soiltypeName + " in sequence " + CropSequenceName;
                GlobalVars.Instance.Error(errorString);
            }
