...
public class manure
{
    ...
    {
        if ((manureType == aManure.manureType) && (speciesGroup == aManure.speciesGroup))
            return true;
        else
            return false;
    }
    ...
    public void Write()
    {
        ...
        GlobalVars.Instance.writeInformationToFiles("storageType", "Storage type", "-", manureType, parens);
