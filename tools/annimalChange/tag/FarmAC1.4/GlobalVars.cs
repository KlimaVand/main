...
public class GlobalVars
{
    ...
    public struct zoneSpecificData
    {
        ...
        public struct C_ToolData
        {
            ...
            public double CNratio;
            public double PupperLayer;
            public double PLoweLayer;
        }
        ...
        public void readZoneSpecificData(int zone_nr, int currentFarmType)
        {
            ...
            for (int j = minSoil; j <= maxSoil; j++)
            {
                ...
                for (int k = minHistory; k <= maxHistory; k++)
                {
                    ...
                    RecipientPath = RecipientStub + "CNratio(-1)";
                    newC_ToolData.CNratio = AEZParamFile.getItemDouble("Value", RecipientPath);
                    RecipientPath = RecipientStub + "PupperLayer(-1)";
                    newC_ToolData.PupperLayer = AEZParamFile.getItemDouble("Value", RecipientPath);
                    RecipientPath = RecipientStub + "PLoweLayer(-1)";
                    newC_ToolData.PLoweLayer = AEZParamFile.getItemDouble("Value", RecipientPath);  
