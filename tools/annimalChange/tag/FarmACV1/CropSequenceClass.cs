...
//        for (int i = 0; i < theCrops.Count; i++)
  //          Console.WriteLine(theCrops[i].GetStartMonth().ToString() + " " + theCrops[i].GetStartYear().ToString() + " " +
             //   theCrops[i].GetEndMonth().ToString() + " " +theCrops[i].GetEndYear().ToString());
        for (int i = 0; i < theCrops.Count; i++)
        {
            CropClass aCrop = theCrops[i];
            //Console.WriteLine(i.ToString() + " " + aCrop.GetStartYear().ToString() + " " + aCrop.GetEndYear().ToString());
   ...
   public void getGrazedFeedItems()
    ...
    public void CalcModelledYield()
    {
        ...
        for (int i = 0; i < theCrops.Count; i++)
        {
            ...
            theCrops[i].DoCropInputs(true);
            /*    if ((theCrops[i].GetContinues())&&(i<(theCrops.Count-1)))
                    theCrops[i+1].SetpreviousPhaseCropNuptake(theCrops[i].GetCropNuptake());*/
            resetC_Tool();
