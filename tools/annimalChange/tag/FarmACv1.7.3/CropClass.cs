...
//            double temp = residueFromPrevious.composition.Getamount() * theProducts[i].composition.GetN_conc();
    ...
    public void WritePlantFile(double deltaSoilN)
    {
        int times = 1;
        ...
        for (int j = 0; j < times; j++)
        {
            ...
            GlobalVars.Instance.writePlantFile("residueNtoNextCrop", "N in residues passed to next crop", "kgN/ha", residueNtoNextCrop, Parens, 0);
