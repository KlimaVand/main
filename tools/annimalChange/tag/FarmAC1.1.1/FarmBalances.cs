   ...
   //!nitrous oxide emissions from crop residues
    ...
    public void WriteFarmBalances()
        ...
        if (agriculturalArea > 0)
        {
            ...
            GlobalVars.Instance.writeInformationToFiles("totalHouseStoreNlossInFarmBalance", "Total N losses from product storage, housing and manure storage", "kg N/yr", totalHouseStoreNloss / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("totalFieldNlossesInFarmBalance", "Total N losses from fields", "kg N/yr", totalFieldNlosses / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("changeAllSoilNstoredInFarmBalance", "Change in N stored in organic and mineral form in soil", "kg N/yr", changeAllSoilNstored / agriculturalArea, parens);
