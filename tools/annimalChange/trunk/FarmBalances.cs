...
class farmBalanceClass
{
   ...
   //!nitrous oxide emissions from crop residues
    ...
    //economics
    //!fertiliser
    double fertiliserPurchase = 0;
    //animal feed and bedding material
    double plantProductPurchase = 0;
    //crop products
    double plantProductSale = 0;
    //animal growth
    double meatSale = 0;
    //milk production
    double milkSale=0;
    //livestock non-feed costs
    double nonFeedCosts = 0;
    //average gross margin
    double averageGrossMargin = 0;
...
*/
    ...
    double waterExhaled;
    double waterExportedManure;
    double waterExportedOther;
    double manurePexported;
    double manurePimported;
    double plantPexported;
    double plantPimported;
    double livestockPexported;
    double fertPimported;
    double Pbalance;
/**
* get water Exhaled
*/
...
/**
* get water Exported Manure
*/
    public double getwaterExportedManure() { return waterExportedManure; }
/**
* set water Exported Manure
*/
    public void SetwaterExportedManure(double newValue) { waterExportedManure = newValue; }
/**
* get water Exported Other
*/
    public double getwaterExportedOther() { return waterExportedOther; }
/**
* Set water Exported Other
*/
    public void SetwaterExportedOther(double newValue) { waterExportedOther = newValue; }
/**
* get manure Pexported
*/
    public double getmanurePexported() { return manurePexported; }
/**
* get manure Pimported
*/
    public double getmanurePimported() { return manurePimported; }
/**
* Set manure Pexported P
*/
    public void SetmanurePexportedP(double newValue) { manurePexported = newValue; }
/**
* get plant P exported
*/
    public double getplantPexported() { return plantPexported; }
/**
*  Set plant P exported
*/
    public void SetplantPexported(double newValue) { plantPexported = newValue; }
/**
* get livestock P exported
*/
    public double getlivestockPexported() { return livestockPexported; }
/**
* set livestock P exported
*/
    public void SetlivestockPexported(double newValue) { livestockPexported = newValue; }
/**
* get P balance
*/
    public double getPbalance() { return Pbalance; }

    public void CalcFertPimported(List<CropSequenceClass> therotationList)
    {
        fertPimported = 0;
        for (int i = 0; i < therotationList.Count; i++)
        {
            fertPimported += therotationList[i].CalcFertPinput() / therotationList[i].GetlengthOfSequence();
        }
    }

    public void CalcPlantPexported(GlobalVars.product compositeProductExported)
    {
        plantPexported = compositeProductExported.composition.Getamount() * compositeProductExported.composition.GetP_conc();
        plantProductSale = compositeProductExported.composition.Getamount() * compositeProductExported.composition.getsalePrice();
    }

    public void CalcPlantPimported(GlobalVars.product compositeProductImported)
    {
        plantPimported = compositeProductImported.composition.Getamount() * compositeProductImported.composition.GetP_conc();
        plantProductPurchase = compositeProductImported.composition.Getamount() * compositeProductImported.composition.getpurchasePrice();
    }

    public void CalcLivestockP(List<livestock> listOfLivestock)
    {
        livestockPexported = 0;
        for (int i = 0; i < listOfLivestock.Count; i++)
        {
            livestockPexported += (listOfLivestock[i].getmilkP() + listOfLivestock[i].getgrowthP()) * listOfLivestock[i].GetAvgNumberOfAnimal();
            meatSale += listOfLivestock[i].getsalePriceMeat() * listOfLivestock[i].GetavgProductionMeat() * listOfLivestock[i].GetAvgNumberOfAnimal() * 365.25;
            milkSale += listOfLivestock[i].getsalePriceMilk() * listOfLivestock[i].GetavgProductionMilk() * listOfLivestock[i].GetAvgNumberOfAnimal() * 365.25;
            nonFeedCosts += listOfLivestock[i].getnonFeedCosts() * listOfLivestock[i].GetAvgNumberOfAnimal();
        }
    }
...
/**
    * Calc P balance
    */
    public void CalcPbalance(List<CropSequenceClass> therotationList)
    {
        CalcFertPimported(therotationList);
        manurePimported = 0;
        manurePexported = 0;
        for (int i = 0; i < GlobalVars.Instance.theManureExchange.GetmanuresImported().Count; i++)
            manurePimported += GlobalVars.Instance.theManureExchange.GetmanuresImported()[i].getphosphorus();
        for (int i = 0; i < GlobalVars.Instance.theManureExchange.GetmanuresExported().Count; i++)
            manurePexported += GlobalVars.Instance.theManureExchange.GetmanuresExported()[i].getphosphorus();
        Pbalance = fertPimported + manurePimported + plantPimported  - (plantPexported + manurePexported + livestockPexported);
    }


    public void DoEconomics()
    {
        averageGrossMargin = plantProductSale + meatSale + milkSale - (nonFeedCosts + plantProductPurchase + fertiliserPurchase);
    }
/**
* Get Agricultural Area
*/
...
*/
        ...
        List<manureStore> listOfManurestores)
    {
        ...
        if (Math.Abs(diff) > 2 *tolerance)
        {
            ...
            if ((rotationList.Count != 0)&&(GlobalVars.Instance.getstopOnError()))
            {
                WriteFarmBalances(rotationList);
        ...
        CalcPlantPimported(compositeProductImported);
        CalcPlantPexported(compositeProductExported);
        CalcLivestockP(listOfLivestock);
        DoEconomics();
    ...
    public void DoEconomics(List<CropSequenceClass> rotationList)
    {
        int minRotation = 1;
        int maxRotation = rotationList.Count;
        ...
        for (int rotationID = minRotation; rotationID <= maxRotation; rotationID++)
        {
            fertiliserPurchase += rotationList[rotationID - 1].GetFertiliserCost() / rotationList[rotationID - 1].GetlengthOfSequence(); //1.100
        }
   }
/**
* Write Farm Balances
*/
    public void WriteFarmBalances(List<CropSequenceClass> CropSequence)
        {
            double Nsurp = 0;
        ...
        double NinFeedConsumedInHousing = livestockNintake - NinGrazedFeed;
        ...
        GlobalVars.Instance.writeStartTab("FarmPbalance");
        GlobalVars.Instance.writeInformationToFiles("manurePimported", "manurePimported", "-", manurePimported, parens);
        GlobalVars.Instance.writeInformationToFiles("plantPimported", "plantPimported", "-", plantPimported, parens);
        GlobalVars.Instance.writeInformationToFiles("manurePexported", "manurePexported", "-", manurePexported, parens);
        GlobalVars.Instance.writeInformationToFiles("plantPexported", "plantPexported", "-", plantPexported, parens);
        GlobalVars.Instance.writeInformationToFiles("livestockPexported", "livestockPexported", "-", livestockPexported, parens);
        GlobalVars.Instance.writeInformationToFiles("Pbalance", "Pbalance", "-", Pbalance, parens);
        if (agriculturalArea > 0)
        {
            GlobalVars.Instance.writeStartTab("PerUnitArea");
            GlobalVars.Instance.writeInformationToFiles("manurePimported", "manurePimported", "-", manurePimported / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("plantPimported", "plantPimported", "-", plantPimported / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("manurePexported", "manurePexported", "-", manurePexported / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("plantPexported", "plantPexported", "-", plantPexported / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("livestockPexported", "livestockPexported", "-", livestockPexported / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("Pbalance", "Pbalance", "-", Pbalance, parens);
            GlobalVars.Instance.writeEndTab();
        }
        GlobalVars.Instance.writeEndTab();
        ...
        GlobalVars.Instance.writeInformationToFiles("farmUnutilisedGrazableDMPercent", "farmUnutilisedGrazableDMPercent", "Percent", 100 * farmUnutilisedGrazableDM/(farmUnutilisedGrazableDM + farmGrazedDM), parens);
       ...
       // GlobalVars.Instance.writeInformationToFiles("farmConcentrateEnergy", "farmConcentrateEnergy", "MJ/yr", farmConcentrateEnergy, parens);
        ...
        //        averageGrossMargin = plantProductSale + meatSale + milkSale - (nonFeedCosts + plantProductPurchase + fertiliserPurchase);
        GlobalVars.Instance.writeStartTab("Economics");
        GlobalVars.Instance.writeInformationToFiles("plantProductPurchase", "plantProductPurchase", GlobalVars.Instance.theZoneData.Getcurrency(), plantProductPurchase, parens);
        GlobalVars.Instance.writeInformationToFiles("fertiliserPurchase", "fertiliserPurchase", GlobalVars.Instance.theZoneData.Getcurrency(), fertiliserPurchase, parens);
        GlobalVars.Instance.writeInformationToFiles("nonFeedCosts", "nonFeedCosts", GlobalVars.Instance.theZoneData.Getcurrency(), nonFeedCosts, parens);
        GlobalVars.Instance.writeInformationToFiles("plantProductSale", "plantProductSale", GlobalVars.Instance.theZoneData.Getcurrency(), plantProductSale, parens);
        GlobalVars.Instance.writeInformationToFiles("meatSale", "meatSale", GlobalVars.Instance.theZoneData.Getcurrency(), meatSale, parens);
        GlobalVars.Instance.writeInformationToFiles("milkSale", "milkSale", GlobalVars.Instance.theZoneData.Getcurrency(), milkSale, parens);
        GlobalVars.Instance.writeInformationToFiles("averageGrossMargin", "averageGrossMargin", GlobalVars.Instance.theZoneData.Getcurrency(), averageGrossMargin, parens);
        if (agriculturalArea > 0)
        {
            GlobalVars.Instance.writeInformationToFiles("plantProductPurchase", "plantProductPurchase", GlobalVars.Instance.theZoneData.Getcurrency(), plantProductPurchase / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("fertiliserPurchase", "fertiliserPurchase", GlobalVars.Instance.theZoneData.Getcurrency(), fertiliserPurchase / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("nonFeedCosts", "nonFeedCosts", GlobalVars.Instance.theZoneData.Getcurrency(), nonFeedCosts / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("plantProductSale", "plantProductSale", GlobalVars.Instance.theZoneData.Getcurrency(), plantProductSale / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("meatSale", "meatSale", GlobalVars.Instance.theZoneData.Getcurrency(), meatSale / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("milkSale", "milkSale", GlobalVars.Instance.theZoneData.Getcurrency(), milkSale / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("averageGrossMargin", "averageGrossMargin", GlobalVars.Instance.theZoneData.Getcurrency(), averageGrossMargin / agriculturalArea, parens);
        } GlobalVars.Instance.writeEndTab();
