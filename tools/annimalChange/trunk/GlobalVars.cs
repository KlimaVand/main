...
*/
    ...
    private int zoneNr;
/**
* get Humification consentration
*/
...
*/
        public void readZoneSpecificData(int zone_nr, int currentFarmType)
        {
            ...
            AEZParamFile.setPath("AgroecologicalZone(" + zone_nr.ToString() + ").Economics(-1).Currency(-1)");
            currency = AEZParamFile.getItemString("Value");
            AEZParamFile.setPath("AgroecologicalZone(" + zone_nr.ToString() + ").Economics(-1).InterestRate(-1)");
            interestRate = AEZParamFile.getItemDouble("Value");
        }         
    }
            ...
            if ((gotit == false) || (amountNNeeded >0))
            {
                ...
                while ((i < manuresImported.Count)&&(gotit==false))
                {
                    if (manuresImported[i].isSame(aManure))  //there is already some of this manure that will be imported
                    {
                        ...
                        aManure.Setphosphorus(manuresImported[i].getphosphorus() * proportion);
                ...
                if (gotit!=true)
                    {
                        ...
                        while ((i <= max)&&(gotit==false))
                        {
                            ...
                            {
                                if ((ManureType > 12) || (SpeciesGroupFile == speciesGroup))
                                {
                                    itemNr = i;
                                    gotit = true;
                                }
...
/**
* write information to plant file
*/
...
/**
* write information to livestock file
*/
...
/**
* write information to ctool file
*/
...
/**
* initialise Feed An dProduct Lists
*/
...
/**
* Add Grazable Product Unutilised
*/
...
/**
* Calc All Feed And Products Potential
*/
...
* Write seyda file
*/
    public void openSeyda(string outputDir, string scenarioNr)
    {
        Seyda = new System.IO.StreamWriter(outputDir + "Seyda" + scenarioNr + ".xls");
     }
/**
* Write seyda file
*/
