...
/**
     * get runoff Water
     */
    public double getrunoffWater() { return runoffWater; }
/**
 * Set runoff Water
 */
    public void SetrunoffWater(double newValue) { runoffWater = newValue; }
/**
 * get inputP
 */
 ...
 * get spilt FeedP
 */
    public double getspiltFeedP() { return spiltFeedP; }
/**
 * Set spiltFeedP
 */
    public void SetspiltFeedP(double newValue) { spiltFeedP = newValue; }
/**
 * get outputP
 */
 ...
 */
    public void Write()
    {
        ...
        GlobalVars.Instance.writeInformationToFiles("runoffWater", "runoffWater", "-", runoffWater, parens);
        GlobalVars.Instance.writeInformationToFiles("inputP", "inputP", "-", inputP, parens);
        GlobalVars.Instance.writeInformationToFiles("spiltFeedP", "spiltFeedP", "-", spiltFeedP, parens);
