        ...
        if (inUse == false)
        {
            ...
            try
            {
                ...
                catch
                {
                    ...
                    {
                        Console.WriteLine(nameOfFile + " not found", "in FileInformation(string nameOfFile)", false);
            ...
            catch (Exception e)
            {
                ...
                if (!nameOfFile.Contains("Alternative.xml"))
                {
                    Console.WriteLine(e.ToString(), 5);
                    if (e.Message.CompareTo("farm Fail") != 0)
                    {
                        ...
                        Console.WriteLine(messageString, e.StackTrace, true);
                    }
                    else
                    {
                        throw new System.Exception("farm Fail");
