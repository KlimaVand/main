    ...
    public livestock(string aPath, int id, int zoneNr, int AnimalNr, string aParens)
    {
        ...
        if (avgNumberOfAnimal > 0)
        {
            ...
            for (int i = min; i <= max; i++)
            {
                ...
                newHouse.setParens(parens + "_" + i.ToString());
                ...
                for (int j = minManureRecipient; j <= maxManureRecipient; j++)
                {
                    if (livestockFile.doesIDExist(j))
                    {
                        ...
                        newRecipient.setParens(parens + "_" + i.ToString() + "_" + j.ToString());
...
/*    public double GetMilkProtein()//kg protein per year
    ...
    */
    ...
    /*public void CalcProteinDemand()//kg per year
    {
        proteinDemand = GetmaintenanceProtein() + GetGrowthProtein() + GetMilkProtein();
    }
    */
...
//                avgProductionMeat -= weightlLoss;
    ...
    public void Write()
    {
        ...
        GlobalVars.Instance.writeStartTab("LiveStock",true);
        ...
        GlobalVars.Instance.writeInformationToFiles("energyIntake", "Intake of energy", "MJ/day", energyIntake / numofDaysInYear, parens,true);
        GlobalVars.Instance.writeInformationToFiles("energyUseForGrowth", "Energy used for growth", "MJ/day", energyUseForGrowth / numofDaysInYear, parens,true);
        GlobalVars.Instance.writeInformationToFiles("energyUseForMilk", "Energy used for milk production", "MJ/day", energyUseForMilk / numofDaysInYear, parens,true);
        GlobalVars.Instance.writeInformationToFiles("energyFromRemobilisation", "Energy supplied by remobilisation", "MJ/day", energyFromRemobilisation / numofDaysInYear, parens,true);
        GlobalVars.Instance.writeInformationToFiles("energyUseForMaintenance", "Energy used for maintenance", "MJ/day", energyUseForMaintenance / numofDaysInYear, parens,true);
        ...
        GlobalVars.Instance.writeInformationToFiles("urineC", "C in urine", "kg", urineC, parens);
        GlobalVars.Instance.writeInformationToFiles("faecalC", "C in faeces", "kg", faecalC, parens);
        ...
        GlobalVars.Instance.writeInformationToFiles("avgDailyProductionMilk", "Average daily milk production", "kg/day", avgProductionMilk, parens,true);
        ...
        GlobalVars.Instance.writeInformationToFiles("avgProductionMeat", "Average weight change", "g/day", avgProductionMeat * 1000.0, parens,true);
