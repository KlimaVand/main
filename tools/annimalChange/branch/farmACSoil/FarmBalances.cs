   ...
   //!nitrous oxide emissions from crop residues
        ...
        List<manureStore> listOfManurestores)
    {
        ...
        for (int rotationID = minRotation; rotationID <= maxRotation; rotationID++)
        {
            ...
            soilCO2Emission += rotationList[rotationID - 1].GetsoilCO2Emission() / rotationList[rotationID - 1].GetlengthOfSequence();
        ...
        CLost += processStorageCloss + soilCO2Emission + soilCleached + burntResidueC;
        ...
        for (int i = 0; i < listOfHousing.Count; i++)
        {
            ...
            //houseToStorageN += ahouse.getManureNitrogen();
    ...
    public void WriteFarmBalances()
        ...
        GlobalVars.Instance.writeInformationToFiles("liveFeedImportN", "??", "??", liveFeedImportN, parens);
        GlobalVars.Instance.writeInformationToFiles("liveGrazedN", "??", "??", liveGrazedN, parens);
        GlobalVars.Instance.writeInformationToFiles("liveToHousingN", "??", "??", liveToHousingN, parens);
        GlobalVars.Instance.writeInformationToFiles("liveToFieldN", "??", "??", liveToFieldN, parens);
        GlobalVars.Instance.writeEndTab();

        GlobalVars.Instance.writeStartTab("housing");
        GlobalVars.Instance.writeInformationToFiles("houseInFromAnimalsN", "??", "??", houseInFromAnimalsN, parens);
        GlobalVars.Instance.writeInformationToFiles("houseLossN", "??", "??", houseLossN, parens);
        GlobalVars.Instance.writeInformationToFiles("houseToStorageN", "??", "??", houseToStorageN, parens);
        GlobalVars.Instance.writeEndTab();

        GlobalVars.Instance.writeStartTab("ManureStorage");
        GlobalVars.Instance.writeInformationToFiles("storageFromHouseN", "??", "??", storageFromHouseN, parens);
        GlobalVars.Instance.writeInformationToFiles("storageFromBeddingN", "??", "??", storageFromBeddingN, parens);
        GlobalVars.Instance.writeInformationToFiles("storageFromFeedWasteN", "??", "??", storageFromFeedWasteN, parens);
        GlobalVars.Instance.writeInformationToFiles("storageGaseousLossN", "??", "??", storageGaseousLossN, parens);
        GlobalVars.Instance.writeInformationToFiles("storageRunoffN", "??", "??", storageRunoffN, parens);
        GlobalVars.Instance.writeInformationToFiles("manureImportN", "??", "??", manureImportN, parens);
        GlobalVars.Instance.writeInformationToFiles("manureExportN", "??", "??", manureExportN, parens);
        GlobalVars.Instance.writeEndTab();

   

        GlobalVars.Instance.writeStartTab("Fields");
        GlobalVars.Instance.writeInformationToFiles("manureToFieldN", "??", "??", manureToFieldN, parens);
        GlobalVars.Instance.writeInformationToFiles("fieldGaseousLossN", "??", "??", fieldGaseousLossN, parens);
        GlobalVars.Instance.writeInformationToFiles("fieldNitrateLeachedN", "??", "??", fieldNitrateLeachedN, parens);
        GlobalVars.Instance.writeInformationToFiles("grazedN", "??", "??", grazedN, parens);
        GlobalVars.Instance.writeInformationToFiles("changeSoilN", "??", "??", changeSoilN, parens);
        GlobalVars.Instance.writeInformationToFiles("fieldharvestedConsumedN", "??", "??", fieldharvestedConsumedN, parens);
        GlobalVars.Instance.writeEndTab();
        ...
        GlobalVars.Instance.writeInformationToFiles("soilCO2Emission", "C in CO2 emitted by the soil", "kg C/yr", soilCO2Emission, parens);
        ...
        if (agriculturalArea > 0)
        {
            ...
            GlobalVars.Instance.writeInformationToFiles("soilCO2Emission", "C in CO2 emitted by the soil", "kg C/ha/yr", soilCO2Emission / agriculturalArea, parens);
        ...
        if (agriculturalArea > 0)
        {
            ...
            GlobalVars.Instance.writeInformationToFiles("NDeltaMineral", "Change in N stored in mineral form in soil", "kg N/yr", changeInMinN / agriculturalArea, parens);
            ...
            GlobalVars.Instance.writeInformationToFiles("totalHouseStoreNloss", "Total N losses from product storage, housing and manure storage", "kg N/yr", totalHouseStoreNloss / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("totalFieldNlosses", "Total N losses from fields", "kg N/yr", totalFieldNlosses / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("changeAllSoilNstored", "Change in N stored in organic and mineral form in soil", "kg N/yr", changeAllSoilNstored / agriculturalArea, parens);
            GlobalVars.Instance.writeInformationToFiles("Nbalance", "N balance (should be about zero)", "kg N/ha/yr", Nbalance / agriculturalArea, parens);
            GlobalVars.Instance.writeEndTab();
        }
        GlobalVars.Instance.writeEndTab();
