    ...
    class simpleSoil
    {
        ...
        */
            ...
            double [] layerOrgC)
        {
            ...
            double Sandfraction = GlobalVars.Instance.theZoneData.thesoilData[soilIndex].SandFraction;
            ...
            for (int index = 0; index < GlobalVars.Instance.theZoneData.thesoilData[soilIndex].thesoilWaterData.thesoilLayerData.Count; index++)
            {
                ...
                if (index <= 1)
                    ...
                    layerOM = 100 * 2 * layerOrgC[1] / (10000 * 1000 * 0.5);
                double PWP = 100 * GetPermanentWilting(Sandfraction, Clayfraction, layerOM);
                double fieldCapacity = 100 * GetFieldCapacity(Sandfraction, Clayfraction, layerOM);
            ...
            if (totalLAI > 0)
            {
                ...
                else  //calculate contents of the upper rooting pool
                {
                    ...
                    else
                    {
                        ...
                        rel_drought = 1 - transpire / croppotEvapGreen;
                    }
                }
            }
