...
/*        tmp = 0;
    ...
    public void CalcModelledYield()
    {
        ...
        for (int i = 0; i < theCrops.Count; i++)
        {
            ...
            while ((gotit == false) || (doneOnce == false))//iterate for each crop, until the crop yield stabilises (note special treatment of grazed crops)
            {
                ...
                RunCropCTool(false, false, i, Temperature, meanDroughtFactor, 0, ref CropCinputToSoil, ref CropNinputToSoil, ref ManCinputToSoil, ref ManNinputToSoil, 
            ...
            RunCropCTool(false, true, i, Temperatures, meanDroughtFactor, 0, ref CropCinputToSoil, ref CropNinputToSoil, ref ManCinputToSoil, ref ManNinputToSoil, ref CropsoilCO2_CEmission, ref CropCleached, ref mineralisedN);
   ...
   public void spinup(ref double startsoilMineralN, double initialFOM_Cinput, double InitialFOMCtoN, double[] meanTemperature)
    {
...
/*               if ((i == 377) && (k == 323))
               ...
               thesoilWaterModel.dailyRoutine(potevapotrans, precip, airTemp, LAI, rootingDepth, ref droughtFactor);
               ...
               /*Console.WriteLine("Crop " + i + " k " + k + " precip " + precip.ToString("F3") + " evap " + evap.ToString("F3")
                   + " drought " + droughtFactor.ToString("F3") + " drain " + drainage.ToString("F3")
