...
tid0=Timer
   CalculateManure NPercent,scale,arrA,arrB,warning, dummy1, dummy2
'tid1=Timer   
...
if Session("usertype")=50 then
    Response.Write("      <th align=""left"">&nbsp;&nbsp;Fix. afgr. + udlæg</th>" & vbCr)
...
'			end if
			if Cint(arrFieldPlanRotation(f,dictFieldPlanRotation("PreCrop_AfterCrop")))<>0 then
			       Response.write("<br>->"&arrFieldPlanRotation(f,dictFieldPlanRotation("PreCrop_AfterCrop_Name")))
		  end if
