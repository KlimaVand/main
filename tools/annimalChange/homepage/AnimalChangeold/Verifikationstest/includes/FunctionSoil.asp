...
' Response.write "<br> C from crops, per ha: " &totalCarbonCrop  
   ...
   ntotalCarbonManure = CallSP ("GetTotalCarbonFromManure " & CLng(Session("farmNumber")) & "," & CInt(Session("scenarioNumber")) & "," & arrRotation(r,0), arrtotalCarbonManure, dicttotalCarbonManure)
