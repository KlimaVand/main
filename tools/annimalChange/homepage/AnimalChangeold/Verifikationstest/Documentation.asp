...
sub CreatePageUK
  ...
  response.write("  <td><iframe name=""iframe"" src=""dokumentation/manual_lille.pdf"" width=""800"" height=""550""></iframe></td>" & vbCr)
  response.write(" <tr>" & vbCr)
  response.write("</table>" & vbCr)
end sub
'**************************************************************************************************
sub CreatePageDK
  ...
  response.write("         <a href=""dokumentation/manual_lille_Dansk.pdf"" target=""iframe"">Generel introduktion</a>" & vbCr)
	...
	response.write("  <br/><br/><a href=""dokumentation/beregning foderbehov.pdf"" target=""iframe"">Foderbehov til kvæg</a>" & vbCr)
	response.write("  <br/><br/><a href=""dokumentation/staldtype og lagre.pdf"" target=""iframe"">Stald- og lagertyper til kvæg</a>" & vbCr)
	...
	response.write("  <br/><br/><a href=""http://www.agrsci.dk/var/agrsci/storage/original/application/6b5cf311a01dd1d8eb7c33a34ed63b54.pdf"" target=""iframe"">Samspillet mellem jordpuljeændringer, N-balancer og udvaskning</a>" & vbCr)
	response.write("  <br/><br/><a href=""http://www.agrsci.dk/var/agrsci/storage/original/application/47408f8f5a2bfd4be07038c49b7508c9"" target=""iframe"">Husdyrgødning</a>" & vbCr)
  response.write("  </td>" & vbCr)
  response.write("  <td><iframe name=""iframe"" src=""dokumentation/manual_lille_Dansk.pdf"" width=""800"" height=""550""></iframe></td>" & vbCr)
  response.write(" <tr>" & vbCr)
  response.write("</table>" & vbCr)
end sub
'**************************************************************************************************
...
%>
<br/><h2>Beregning af foderbehov til kvæg</h2>
<em>Troels Kristensen</em><br>
30 sept. 2003&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="stald.htm">Stald- og lagertyper til kvæg</a>
<p>
Foderbehovet udtrykkes pr årsdyr (365 foderdage) ud fra standard effektivitet for energi- og proteinudnyttelse. Der er anvendt følgende kilder</p>
<ul>
...
<table border=1 cellspacing=0 cellpadding=3>
 ...
 <tr>
  ...
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  <td colspan=2><font size=1>For ovenstående prod.</font></td>
 </tr>
 <tr>
  <td>- energi, FE</td>
 ...
 <tr>
  <td>Gødning, kg N ab dyr</td>
  <td>N foder - N mælk – N tilvækst</td>
  <td>129</td>
  <td>102</td>
  <td>192</td>
 </tr>
 <tr>
  <td>- afsat på marken, pct</td>
  <td>(FE afgræsning*100) / FE</td>
  <td>0</td>
  <td>0</td>
  <td>19</td>
 </tr>
 <tr>
  <td>- andel i fæces, pct</td>
  <td>(((0,04*(N foder <i>g/dag</i>)+((tørstof<sup>2</sup> <i>kg/dag</i>*1,8)/6,25)+((tørstof <i>kg/dag</i>*20)/6,25))*100)/(N foder – N mælk – N tilvækst) 1)</td>
  <td>51</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
 </tr>
 ...
 <tr>
  <td>- N, pct</td>
  <td>((N mælk+N tilvækst)*100)/N foder</td>
  <td>26,3</td>
  <td>26,1</td>
  <td>25,9</td>
 </tr>
...
<h3>Tunge racer – opdræt ved en kælvealder på 26 mdr.</h3>
<table border=1 cellspacing=0 cellpadding=3>
 <tr>
  <td><B>Område</B></td>
  <td><B>Beregning</B></td>
 ...
 <tr>
  <td>- tørstof, kg</td>
  <td>FE*1,35+0,00025*(700-tilvækst)</td>
  <td>2272</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
 </tr>
 <tr>
  <td>- N, kg</td>
  <td>FE*0,025+10*(FE afgræsning/FE)</td>
  <td>42</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
 </tr>
 ...
 <tr>
  <td>- andel i fæces, pct</td>
  <td>(((0,04*(N foder, <i>g/dag</i>)+((tørstof<sup>2</sup> <i>kg/dag</i>*1,8)/6,25)+((tørstof <i>kg/dag</i>*20)/6,25))*100)/(N foder – N tilvækst) 1)</td>
  <td>37</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
 </tr>
...
1) Ligning side 49 i DJF Rapport Husdyrbrug nr 36.</p>
<p>
<h3>Tunge racer – ungtyre med en afgangsvægt på 450 kg.</h3>
<table border=1 cellspacing=0 cellpadding=3>
 <tr>
  <td><B>Område</B></td>
  <td><B>Beregning</B></td>
...
<h3>Jersey racer – opdræt ved en kælvealder på 24 mdr.</h3>
<table border=1 cellspacing=0 cellpadding=3>
 <tr>
  <td><B>Område</B></td>
  <td><B>Beregning</B></td>
 ...
 <tr>
  <td>- tørstof, kg</td>
  <td>FE*1,35+0,00025*(500-tilvækst)</td>
  <td>2292</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
 </tr>
...
<h3>Jersey racer – ungtyre med en afgangsvægt på 300 kg.</h3>
<table border=1 cellspacing=0 cellpadding=3>
 <tr>
  <td><B>Område</B></td>
  <td><B>Beregning</B></td>
