...
'   Response.Write("<span id=""veil"" style=""position: absolute; top: 0px; left: 0px; height: 100%; width: 100%; background-color: #C8E1F3; display: none;""><blink style=""position: relative; top: 50%; left: 50%;"">In progress...</blink></span>" & vbCr)
   Response.Write("<form name=""formFieldPlan"" action="""" method=""post"" accept-charset=""utf-8"">" & vbCr)
   if nRotation < 1  then
...
'	  Response.Write("<select style=""width: 260px;"" name=""SoilType_"&aRotationID&""" onChange=""if ((this.options[this.selectedIndex].value=='1')||(this.options[this.selectedIndex].value=='2')||(this.options[this.selectedIndex].value=='3')||(this.options[this.selectedIndex].value=='4')){document.forms.formFieldPlan.Irrigation_"&aRotationID&".disabled=false;}else{document.forms.formFieldPlan.Irrigation_"&aRotationID&".options[0].selected=true;document.forms.formFieldPlan.Irrigation_"&aRotationID&".disabled=true;};document.forms.formFieldPlan.action='FieldPlanUpdate.asp?RotationID="&aRotationID&"&Irrigation_"&aRotationID&"=0';document.forms.update.action='javascript:document.forms.formFieldPlan.submit();';this.style.color='#ff0000';"">" & vbCr)
	  Response.Write("<select style=""width: 260px;"" name=""SoilType_"&aRotationID&""" onchange=""document.forms.formFieldPlan.action='FieldPlanUpdate.asp?RotationID="&aRotationID&"';document.forms.update.action='javascript:document.forms.formFieldPlan.submit();';this.style.color='#ff0000';"">" & vbCr)
...
'	  Response.Write("</select>" & vbCr)
	  Response.Write("</td>" & vbCr)
	  Response.Write("      <td align=""left""><h4>"&Str.Item("strAREA")&": </h4><input type=""text"" id=""inputArea_"&aRotationID&""" name=""inputArea_"&aRotationID&""" value="""&Round(aTotalArea,1)&""" maxlength=""5"" size=""2"" onChange=""if (isFinite(this.value.replace(',','.'))) {this.value=this.value.replace('.',',');document.forms.formFieldPlan.action='FieldPlanUpdate.asp?RotationID="&aRotationID&"';this.style.color='#ff0000';}""/>Ha</td>" & vbCr)
...
'	  Response.Write("</h4></td>" & vbCr)
      ...
      Response.Write("      <th align=""left"">"&Str.Item("strSecondary")&" "&Str.Item("strFeedstuff")&"</th>" & vbCr)
...
'         Response.Write("<input type=""text"" size=""9"" name=""endDate_"&aRotationID&"_"&f&""" id=""endDate_"&aRotationID&"_"&f&""" value="""&aEndDate&""" onchange="""&strEndDateCheck&""" onkeydown=""if (document.event.keyCode==13){document.forms.formFieldPlan.action='FieldPlanUpdate.asp?RotationID="&aRotationID&"';document.forms.formFieldPlan.submit();};"">")
...
''         Response.Write("&nbsp;&nbsp;<button style=""width: 100px; height: 20px; font-size: 10px"" onclick="""">"&Str.Item("strDELETECROP")&"</button>")
''         Response.Write("&nbsp;&nbsp;<button style=""width: 100px; height: 20px; font-size: 10px"" onClick=""if (document.event.keyCode!=13) {if(confirm('"&Str.Item("strBekræftafgrøde")&"')) {veil();document.forms.formFieldPlan.action='FieldPlanDelete.asp?RotationID="&aRotationID&"&FieldPlanID="&arrFieldPlan(f,dictFieldPlan.item("FieldPlanID"))&"';document.forms.formFieldPlan.submit();}}"">"&Str.Item("strDELETECROP")&"</button>")
'         Response.Write("&nbsp;&nbsp;<button style=""width: 100px; height: 20px; font-size: 10px"" onclick=""if(confirm('"&Str.Item("strBekræftafgrøde")&"')) {veil();document.forms.formFieldPlan.action='FieldPlanDelete.asp?RotationID="&aRotationID&"&FieldPlanID="&arrFieldPlan(f,dictFieldPlan.item("FieldPlanID"))&"';document.forms.formFieldPlan.submit();}"">"&Str.Item("strDELETECROP")&"</button>")
'		 else
'         Response.Write("&nbsp;")
'         end if
         Response.Write("</td>" & vbCr)   
      ...
      Response.Write("<button style=""width: 125px; height: 20px; font-size: 10px"" onClick=""javascript:if (checkStartEndDate("&aRotationID&","&f&")) {} else {veil();document.forms.formFieldPlan.action='FieldPlanUpdate.asp?RotationID="&aRotationID&"';document.forms.formFieldPlan.submit();return true;};"">"&Str.Item("strSAVEROT")&"</button>")
'      Response.Write("<button style=""width: 125px; height: 20px; font-size: 10px"" onClick=""javascript:document.forms.formFieldPlan.action='FieldPlanUpdate.asp?RotationID="&aRotationID&"';document.forms.formFieldPlan.submit();"">"&Str.Item("strSAVEROT")&"</button>")
      Response.Write("&nbsp;")   
      Response.Write("<button style=""width: 125px; height: 20px; font-size: 10px"" onClick=""javascript:if (checkStartEndDate("&aRotationID&","&f&")) {} else {veil();document.forms.formFieldPlan.action='FieldPlanNew.asp?RotationID="&aRotationID&"';document.forms.formFieldPlan.submit();return true;}"">"&Str.Item("strNEWCROP")&"</button>")
      Response.Write("&nbsp;")   
      ...
      Response.Write("</td>" & vbCr)
      Response.Write("<td></td><td></td><td>" & vbCr)
'		 if f = nFieldPlan-1 then
'         Response.Write("&nbsp;&nbsp;<button style=""width: 100px; height: 20px; font-size: 10px"" onclick="""">"&Str.Item("strDELETECROP")&"</button>")
'         Response.Write("&nbsp;&nbsp;<button style=""width: 100px; height: 20px; font-size: 10px"" onClick=""if (document.event.keyCode!=13) {if(confirm('"&Str.Item("strBekræftafgrøde")&"')) {veil();document.forms.formFieldPlan.action='FieldPlanDelete.asp?RotationID="&aRotationID&"&FieldPlanID="&arrFieldPlan(f,dictFieldPlan.item("FieldPlanID"))&"';document.forms.formFieldPlan.submit();}}"">"&Str.Item("strDELETECROP")&"</button>")
         Response.Write("&nbsp;&nbsp;<button style=""width: 150px; height: 20px; font-size: 10px"" onclick=""if(confirm('"&Str.Item("strBekræftafgrøde")&"')) {veil();document.forms.formFieldPlan.action='FieldPlanDelete.asp?RotationID="&aRotationID&"&FieldPlanID="&arrFieldPlan(f-1,dictFieldPlan.item("FieldPlanID"))&"';document.forms.formFieldPlan.submit();}"">"&Str.Item("strDELETECROP")&"</button>")
'		 else
'         Response.Write("&nbsp;")
'         end if   
      Response.Write("</td>" & vbCr)
...
'   Response.Write("<form name=""update"" action=""javascript:document.forms.formFieldPlan.submit();"" method=""post"">" & vbCr)
   Response.Write("<form name=""update"" accept-charset=""utf-8"">" & vbCr)
