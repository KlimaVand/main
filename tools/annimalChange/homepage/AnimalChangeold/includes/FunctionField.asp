...
'end sub
'**************************************************************************************************
sub CalculateManure(version, NPercent, scale,arrA,arrB, warning, TotalBoughtManure, TotalSoldManure)
...
totalNDist=FillArrays (c,f,arrA,arrB,arrHGdistribute,arrNNeed,ObjectCoeff,arrDelivery,totalManureShareOfNNeed,totalManureNContent,BoughtFertilizer,arrCalcSoldManure,arrBoughtManure,SalesOrderList,scale,dictNNeed,dictSalesOrderList)
'Response.write "<br> ObjectCoeff "
'PrintArrayInTable2Nina ObjectCoeff
'tid2=Timer
...
if cint(version) = 1 then	   
    ...
    test = calcRotation1(totalNDist,arrA,arrB,ObjectCoeff,arrResult)
end if
...
InsertUpdateManureDelivery_ny arrA,arrB,ObjectCoeff,arrResult,arrDelivery,arrHGdistribute,arrNNeed,dictNNeed,dictSalesOrderList
...
'  response.write "<br> NprDE "& NprDE
  ...
  response.write "<br>"&Str.Item("strReduction")&" "& round(Reduktion,2) & " "
tid4=Timer
'response.write "<br>Tid0-1  = "&   tid1-tid0
'response.write "<br>Tid1-2  = "&   tid2-tid1
'response.write "<br>Tid2-3  = "&   tid3-tid2
'response.write "<br>Tid3-4  = "&   tid4-tid3
'response.write "<br>Tid ialt  = "&   tid4-tid0

end sub
'**************************************************************************************************
sub FillArrays1(c,f,arrA,arrB,arrHGdistribute,arrNNeed,ObjectCoeff,arrDelivery,totalManureShareOfNNeed,totalManureNContent,BoughtFertilizer,arrCalcSoldManure,arrBoughtManure,SalesOrderList,scale,dictNNeed,dictSalesOrderList)
dim degree,delType,a,b,k,fert,SumA,SumB
Dim arrUtilDegree, dictUtilDegree, X,i
dim arrRowFields,dictUtilDegreeRows,r
'Dim test
i=0
tid1=Timer
'response.write "Ubound(arrHGdistribute):"& Ubound(arrHGdistribute)
'response.write "Ubound(arrNNeed):"& Ubound(arrNNeed)
arrRowFields=split("3,4,5",",")
   set dictUtilDegree = CreateObject("Scripting.Dictionary")
   set dictUtilDegreeRows = CreateObject("Scripting.Dictionary")
   X = CallSPColumnsRows ("GetUtilDegreeDeliveryTypeList " & Session("farmNumber") & "," & Session("scenarioNumber") , arrUtilDegree, dictUtilDegree, dictUtilDegreeRows, arrRowFields)
'   X = CallSP ("GetUtilDegreeDeliveryTypeList " & Session("farmNumber") & "," & Session("scenarioNumber"), arrUtilDegree, dictUtilDegree)
...
'     Response.write "<br> I løkken som sætter koef : b =" &b
     i=cstr(arrNNeed(b,dictNNeed.Item("RotationID")) & "-" & arrNNeed(b,dictNNeed.Item("FieldPlanRotationID")) & "-" & arrHGdistribute(a,dictSalesOrderList.Item("StorageID")))
'     response.write "i:"&i
     degree = Cint(10*arrUtilDegree(dictUtilDegreeRows.Item(i),dictUtilDegree.Item("UtilizationDegree")))
     delType = CInt(arrUtilDegree(dictUtilDegreeRows.Item(i),dictUtilDegree.Item("DeliveryID")))
	 fert =  CBool(arrUtilDegree(dictUtilDegreeRows.Item(i),dictUtilDegree.Item("OrganicFertilizer")))
...
if a=int(Ubound(arrHGdistribute)/2) and b=int(Ubound(arrNNeed)/2) then tid2=Timer
      if fert = true then 
'        test = 1
...
'**************************************************************************************************
sub FillArrays2(c,f,arrA,arrB,arrHGdistribute,arrNNeed,ObjectCoeff,arrDelivery,totalManureShareOfNNeed,totalManureNContent,BoughtFertilizer,arrCalcSoldManure,arrBoughtManure,SalesOrderList,scale,dictNNeed,dictSalesOrderList)
dim degree,delType,a,b,k,fert,SumA,SumB
...
'    PrintArrayInTable2Nina arrUtilDegree
  ...
  '   Response.write "<br> I løkken som sætter koef "
     ...
     degree = Cint(10*arrUtilDegree(0,dictUtilDegree.Item("UtilizationDegree")))
...
'**************************************************************************************************
function FillArrays(c,f,arrA,arrB,arrHGdistribute,arrNNeed,ObjectCoeff,arrDelivery,totalManureShareOfNNeed,totalManureNContent,BoughtFertilizer,arrCalcSoldManure,arrBoughtManure,SalesOrderList,scale,dictNNeed,dictSalesOrderList)
dim degree,delType,a,b,k,fert,SumA,SumB
Dim arrUtilDegree, dictUtilDegree, X,i
'dim arrRowFields,dictUtilDegreeRows,r
'Dim test
...
'     i=cstr(arrNNeed(b,dictNNeed.Item("RotationID")) & "-" & arrNNeed(b,dictNNeed.Item("FieldPlanRotationID")) & "-" & arrHGdistribute(a,dictSalesOrderList.Item("StorageID")))
'     response.write "i:"&i
     degree = Cint(10*arrUtilDegree(i,dictUtilDegree.Item("UtilizationDegree")))
     delType = CInt(arrUtilDegree(i,dictUtilDegree.Item("DeliveryID")))
	 fert =  CBool(arrUtilDegree(i,dictUtilDegree.Item("OrganicFertilizer")))
...
'**************************************************************************************************
sub InsertUpdateManureDelivery_ny(arrA,arrB,ObjectCoeff,arrResult,arrDelivery,arrHGdistribute,arrNNeed,dictNNeed,dictSalesOrderList)
dim a,b,aLoss,m,test,strXML
Dim nManureType, arrManureType
Dim arrParameter, X
ReDim arrParameter(1)
Dim arrParameterInsert(8),localesetting

localesetting=getlocale()
setlocale("en-gb")
   strXML = strXML & "<ManureFertilizerDelivery>"
...
'	     if (arrResult(a,b)>0.01 And ObjectCoeff(a,b)>0) Or (CInt(a)=CInt(9) And CInt(arrB(b))=CInt(0)) then 
   ...
   strXML = strXML & "<row FarmNumber="""&CLng(Session("farmNumber"))&""" "
   strXML = strXML & "ScenarioID="""&CLng(Session("scenarioNumber"))&""" "
   strXML = strXML & "RotationID="""&CInt(arrNNeed(b,dictNNeed.Item("RotationID")))&""" "
'	        arrParameterInsert(2) = CInt(arrNNeed(b,dictNNeed.Item("RotationID")))
   strXML = strXML & "FieldPlanRotationID="""&CInt(arrNNeed(b,dictNNeed.Item("FieldPlanRotationID")))&""" "
'			arrParameterInsert(3) = CInt(arrNNeed(b,dictNNeed.Item("FieldPlanRotationID")))
   strXML = strXML & "StorageID="""&CInt(arrHGdistribute(a,dictSalesOrderList("StorageID")))&""" "
'			arrParameterInsert(4) = CInt(arrHGdistribute(a,dictSalesOrderList("StorageID")))
   strXML = strXML & "DeliveryID="""&CInt(arrDelivery(a,b))&""" "
'			arrParameterInsert(5) = CInt(arrDelivery(a,b))
   strXML = strXML & ">"
   strXML = strXML & "<Kg_N_Delivered>"&Cdbl(arrResult(a,b))&"</Kg_N_Delivered>"
'			arrParameterInsert(6) = Cdbl(arrResult(a,b))
   strXML = strXML & "<Kg_N_Loss>"&CDbl(Round(aLoss*arrResult(a,b)/100,2))&"</Kg_N_Loss>"
'			arrParameterInsert(7) = CDbl(Round(aLoss*arrResult(a,b)/100,2))
   strXML = strXML & "<Kg_N_Utilized>"&Cdbl(arrHGdistribute(a,dictSalesOrderList("N_UtilizationDegree"))*arrResult(a,b))/100&"</Kg_N_Utilized>"
'            arrParameterInsert(8) = Cdbl(arrHGdistribute(a,dictSalesOrderList("N_UtilizationDegree"))*arrResult(a,b))/100
'            X = CallSPReturn("InsertUpdateManureFertilizerDelivery", arrParameterInsert)
        strXML = strXML & "</row>"
...
'response.write strXML
	            X = InsertManureFertilizerDeliveryOpenXML(strXML)'CallSPReturn("InsertManureFertilizerDeliveryOpenXML", strXML)
...
'**************************************************************************************************
  ...
  function calcRotation1(totalNDist,arrA,arrB,ObjectCoeff,arrResult)
  dim a,b,c,r,tot
  tot=totalNDist
   for a=0 to Ubound(arrA)
   tot=arrA(a)
'   response.write "<br>"& arrA(a)
     for b=0 to Ubound(arrB)
'     response.write "<br>    -"& arrB(B)
     arrResult(a,b)=(arrA(a)/totalNDist)*arrB(B)
     tot=tot-arrResult(a,b)
     next
   arrResult(a,b-1)=arrResult(a,b-1)+tot' to ensure balance in total distributed amount of this manuretype
   next 
  calcRotation1=True  
  end function
'**************************************************************************************************
