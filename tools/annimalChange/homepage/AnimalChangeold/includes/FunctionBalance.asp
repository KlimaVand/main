...
'**************************************************************************************************
sub InitTableFeed(byref arrFeed, byref aBoughtFeedN, byref aSoldFeedN, byref HighEnergyConc, ByRef BoughtBeddingN, ByRef SoldBeddingN,internalGrazingDM)
   ...
   dim internalGrazingN ,internalGrazingFE 
   ...
   Dim concCHG, grazingConsumptionDM, arrGrazingConsumptionDM, dictGrazingConsumptionDM
...
'next
'  response.write "<br> ----------------<br>"
   set dictGrazingConsumptionDM = CreateObject("Scripting.Dictionary")
   X = CallSP("getGrazingBalance " & Session("farmNumber")& "," & Session("scenarioNumber") , arrGrazingConsumptionDM, dictGrazingConsumptionDM)
   for i = 0 to ubound(arrGrazingConsumptionDM)
     internalGrazingDM = internalGrazingDM+CDbl(arrGrazingConsumptionDM(i,dictGrazingConsumptionDM.Item("Bought"))) 
   next
'response.write internalGrazingDM
