...
'**************************************************************************************************
   Dim CA1, CA2'global erklæring af disse to arrays
...
'**************************************************************************************************
  ...
  Sub SolveAll (i, j, A, BT,NBcol)
'PrintArrayInTable1Rot CA1
'PrintArrayInTable1Rot CA2
    Do While i <= UBound(CA2) And j >= 0
      Solve i,j,A,BT,NBcol
      NextCell i,j,A,NBcol
      SolveAll i,j,A,BT,NBcol

    Loop
  End Sub
'**************************************************************************************************
  
  Sub Solve (i, j, A, BT, NBcol)
    Dim y 
		Dim x1, x2
		x1 = CA1(j)
		x2 = CA2(i)
