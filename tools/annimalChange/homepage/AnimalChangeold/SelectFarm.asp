...
'   Response.Write("<th>"&Str.Item("strPIG")&"</th>" & vbCr)
   Response.Write("<th>"&Str.Item("strCopyStandardFarm")&"</th>" & vbCr)
   Response.Write("</tr>" & vbCr)
   Response.Write("<tr>" & vbCr)
'   Response.Write("<td></td>" & vbCr)
   Response.Write("<td align=""right"">" & vbCr)
   ...
   CreateSelectList_  aStandardFarm,nStandardFarm,arrStandardFarm
'	    
...
'   Response.Write("<tr>" & vbCr)
'   Response.Write("<td>" & vbCr)
''   Response.write("<a href=""ShowFarm.asp?show=67892"">Grass and cereal rotations + dairy + pigs</a>" & vbCr)
'   Response.Write("</td>" & vbCr)
'   Response.Write("</tr>" & vbCr)
'   Response.Write("<tr>" & vbCr)
'   Response.Write("<td>" & vbCr)
'   Response.write("<a href=""ShowFarm.asp?show=67893"">Cereal and grass rotation</a>" & vbCr)
'   Response.Write("</td>" & vbCr)
'   Response.Write("</tr>" & vbCr)
'   Response.Write("<tr>" & vbCr)
'   Response.Write("<td>" & vbCr)
'   Response.write("<a href=""ShowFarm.asp?show=67895"">Spring barley,winter wheat and grass</a>" & vbCr)
'   Response.Write("</td>" & vbCr)
'   Response.Write("</tr>" & vbCr)
'   Response.Write("<tr>" & vbCr)
'   Response.Write("<td>" & vbCr)
