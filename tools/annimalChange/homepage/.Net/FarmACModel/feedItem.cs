...
* Set sale price
*/
    public void Setsale_price(double newValue) { sale_price = newValue; }
    /**
* get purchase Price
*/
...
* get P conc
*/
    public double getPconc() { return Pconc; }
    /**
* Set P conc
*/
    public void SetPconc(double newValue) { Pconc = newValue; }
    /**
* set Feed Code
*/
...
*/
    public void Write(string theParens)
    {
        ...
        GlobalVars.Instance.writeInformationToFiles("sale_price", "sale_price", "-", sale_price, parens);
        GlobalVars.Instance.writeInformationToFiles("purchasePrice", "purchasePrice", "-", purchasePrice, parens);
        GlobalVars.Instance.writeInformationToFiles("Pconc", "Pconc", "-", Pconc, parens);
