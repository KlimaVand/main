...
public class livestock
{
    ...
    public double getmeatP() { return meatP; }
    public void SetmeatP(double newValue) { meatP = newValue; }
    ...
    public void SetexcretaP(double newValue) { excretaP = newValue; }
...
//                milk = new feedItem();
  //              milk.GetStandardFeedItem(308);//milk feed code in feedstuffs.xml
            }
            else
            {
                if (speciesGroup == 1)
...
/*                    if ((afeedItem.GetisGrazed())&&(GlobalVars.Instance.GetstrictGrazing()))
    ...
    public void Write()
    {
        ...
        GlobalVars.Instance.writeInformationToFiles("meatP", "meatP", "-", meatP, parens);
