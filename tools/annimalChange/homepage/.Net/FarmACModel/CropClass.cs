...
public class CropClass
{
    ...
    double [] manureP=new double[0];
    double[] fertiliserP = new double[0];
    double Pbalance;
    /**
    * get manure p value
    */
    public double[] getmanureP() { return manureP; }
    /**
   * set manure p value
   */
    public void SetmanureP(double[] newValue) { manureP = newValue; }
    /**
   * get fertiliser p value
   */
    public double[] getfertiliserP() { return fertiliserP; }
    /**
* set fertiliser p value
*/
    public void SetfertiliserP(double[] newValue) { fertiliserP = newValue; }
    /**
    * get manure p value
    */
    public double getmanurePat(int index) { return manureP[index]; }
    /**
* set manure p value
*/
    public void SetmanurePat(double newValue, int index) { manureP[index] = newValue; }
    /**
* get fertiliser p value
*/
    public double getfertiliserP(int index) { return fertiliserP[index]; }
    /**
* set fertiliser p value
*/
    public void SetfertiliserP(double newValue, int index) { fertiliserP[index] = newValue; }
    /**
* set P balance
*/
...
* get P balance
*/
    public void SetPbalance(double newValue) { Pbalance = newValue; }
    /**
...
*/
    public void Write()
    {
        GlobalVars.Instance.writeStartTab("CropClass");
            ...
            for (int i = 0; i<manureP.Length; i++)
            {
                GlobalVars.Instance.writeInformationToFiles("manureP", "manureP " + i.ToString(), "-", manureP[i], Parens);
            }
            for (int i = 0; i < fertiliserP.Length; i++)
            {
                GlobalVars.Instance.writeInformationToFiles("fertiliserP", "fertiliserP " + i.ToString(), "-", fertiliserP[i], Parens);
            }
