...
*/
    public void WriteFarmBalances(List<CropSequenceClass> CropSequence)
       ...
       // GlobalVars.Instance.writeInformationToFiles("farmConcentrateEnergy", "farmConcentrateEnergy", "MJ/yr", farmConcentrateEnergy, parens);
        ...
        GlobalVars.Instance.writeInformationToFiles("waterExportedManure", "waterExportedManure", "-", waterExportedManure, parens);
        GlobalVars.Instance.writeInformationToFiles("waterExportedOther", "waterExportedOther", "-", waterExportedOther, parens);
