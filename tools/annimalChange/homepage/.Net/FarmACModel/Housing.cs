...
public class housing
{
    ...
    public double getbedding() { return bedding; }
    public void Setbedding(double newValue) { bedding = newValue; }
    public double getspiltFeedP() { return spiltFeedP; }
    public void SetspiltFeedP(double newValue) { spiltFeedP = newValue; }
    public double getoutput() { return output; }
    public void Setoutpute(double newValue) { output = newValue; }
    ...
    public void Write()
    {
        ...
        GlobalVars.Instance.writeInformationToFiles("bedding", "bedding", "-", bedding, parens);
        GlobalVars.Instance.writeInformationToFiles("spiltFeedP", "spiltFeedP", "-", spiltFeedP, parens);
        GlobalVars.Instance.writeInformationToFiles("output", "output", "-", output, parens);
