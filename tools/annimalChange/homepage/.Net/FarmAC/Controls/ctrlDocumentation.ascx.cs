...
{
    public partial class ctrlDocumentation : System.Web.UI.UserControl
    {
        string language;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["UserInit"] != null)
                if (HttpContext.Current.Session["UserInit"].ToString() == "12")
            {
        ...
        void CreateDocs()
        {
            ...
            this.contentPanel1.Attributes["src"] = "FarmAC users guide v3.htm";
