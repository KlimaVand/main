function result = decompositionFOM(numberOfLayers,depth,avgTemperature,amplitude,offset,usingRK,t,i,fomc,FOMdecompositionrate,tF,humification,humc,TransportFom,Co2Fom,AmountFom,outputInformation,WithTransport,year,month)
