function result = decayHum(numberOfLayers,depth,avgTemperature,amplitude,offset,usingRK,t,i,HUMdecompositionrate,humc,TransportHum,Co2Hum,AmountHum,ROMfraction,romc,outputInformation,WithTransport)
