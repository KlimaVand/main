function romc = decompositionROM(numberOfLayers,depth,avgTemperature,amplitude,offset,usingRK,t,i,TransportRom,Co2Rom,AmountRom,romc,ROMdecompositionrate,outputInformation,WithTransport,year,month)
