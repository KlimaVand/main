function u1 = rk4decay ( t0, u0, dt, f ,k,tempCoefficient)
...
%
  f1 = f ( t0,          u0,k,tempCoefficient );
  f2 = f ( t0 + dt / 2, u0 + dt * f1 / 2 ,k,tempCoefficient);
  f3 = f ( t0 + dt / 2, u0 + dt * f2 / 2,k,tempCoefficient);
  f4 = f ( t0 + dt,     u0 + dt * f3,k,tempCoefficient );
%
