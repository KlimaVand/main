function amount = ctool2erosion(startingAmount,sizeOfObserved, usingRK, runNR, observationWithnan,fullOutput, runName,numberOfPossibleObserved,WithTransport)
