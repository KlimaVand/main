function result = decompositionHUMC14(numberOfLayers,depth,avgTemperature,amplitude,offset,usingRK,t,i,HUMdecompositionrate,humc,TransportHum,Co2Hum,AmountHum,ROMfraction,romc,outputInformation,DecayRate,WithTransport,year,month)
