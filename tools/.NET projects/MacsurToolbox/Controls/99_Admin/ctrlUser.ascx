<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrlUser.ascx.cs" Inherits="MacsurToolbox.Controls._99_Admin.ctrlUser" %>
...
<asp:SqlDataSource ID="SqlDataSourceCountryList" runat="server" ConnectionString="<%$ ConnectionStrings:conMacsur %>" SelectCommand="SELECT CountryID, CountryName FROM Country ORDER BY CountryName"></asp:SqlDataSource>
