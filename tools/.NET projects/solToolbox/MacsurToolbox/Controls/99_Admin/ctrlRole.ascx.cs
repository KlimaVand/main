...
namespace MacsurToolbox.Controls._99_Admin
{
   public partial class ctrlRole : System.Web.UI.UserControl
   {
      ...
      protected void Page_Load(object sender,EventArgs e)
      {
         ...
         strSelectCommandUser="SELECT UserAdditional.UserInit";
         strSelectCommandUser+=",UserAdditional.FirstName + ' ' + UserAdditional.LastName + ' [' + Macsur.dbo.Country.CountryName + ']' AS FullName";
         strSelectCommandUser+=",aspnet_Users.UserId";
         strSelectCommandUser+=",aspnet_Users.ApplicationId";
         strSelectCommandUser+=" FROM UserAdditional";
         strSelectCommandUser+=" INNER JOIN Macsur.dbo.Country ON UserAdditional.CountryID = Macsur.dbo.Country.CountryID";
