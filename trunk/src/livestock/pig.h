...
// Get and set functions for attributes
   ...
   virtual pigstysection* GetanimalSection () { return (pigstysection*) theanimalSection;}
   ...
   void ReceivePlan (commonData * data, char * fileName)  ;
   ...
   virtual double GetSensibleHeatProduction(double weight){
	   theMessage->FatalError("pig::GetSensibleHeatProduction should always be overridden"); return 0.0;};
   virtual double CalcMaintenanceEnergy(double weight){
	   	   theMessage->FatalError("pig::CalcMaintenanceEnergy should always be overridden"); return 0.0;};;
   ...
   double CalcAverageHeatProduction(double startWeight, double endWeight);
   virtual double GetTotalHeatProduction(double weight){
	   theMessage->FatalError("pig::GetTotalHeatProduction should always be overridden"); return 0.0;};
};
#endif
