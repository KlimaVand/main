...
\****************************************************************************/
manurestore::manurestore(const char *aName,const int aIndex,const base* aOwner,string manureType)
{
	...
	theStore= new storage();
		...
		manure * aManure=new manure(manureType.c_str(),0,nullptr);
  ...
  Constructor with arguments
\****************************************************************************/
manurestore::manurestore(const char *aName,const int aIndex,const base* aOwner,commonData *  &runData,commonData * &original)
{
	aBase=new base(aName,aIndex,aOwner);
...
void manurestore::RcvManure(const manure* someManure)
{
	...
	else if (strcmp(theStore->GetProductPointer()->GetName(),"SLURRY")==0)
	{
		if ((strcmp(tmpManure->GetName(),"FLUID-MANURE")==0)||(strcmp(tmpManure->GetName(),"SOLID-MANURE")==0)
				...
				||(strcmp(tmpManure->GetName(),"WHEATSTRAW")==0))
		{
