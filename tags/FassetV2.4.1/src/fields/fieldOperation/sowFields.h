...
class sowFields: public fieldOperationFields
{
	...
	public:
      ...
      virtual sowFields* clone() const;
		virtual void DefineSowFieldsOp(operationNames op,id_string crop,id_string cropNm,int yr,int mon,int d,double ar,int fieldn,double dist,int PVStrategy,seed * theSeed);
