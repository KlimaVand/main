...
{
   private:
   	linkList <product> * theProductSubList;
      linkList <product> * theProductAddList;
      int simulationYear;
   ...
   protected:
      linkList<product>* theDemandList;
   ...
   public:
      ...
      // Set functions
       void SettheProductSubList(linkList <product> *& atheProductSubList) {theProductSubList = atheProductSubList;}
       void SettheProductAddList(linkList <product> *& atheProductAddList) {theProductAddList = atheProductAddList;}
       void addDemand(product* aProduct);
//       void SetSellPlantProducts(bool value){SellPlantProducts=value;};

      // Get functions
      linkList <product> * GettheProductSubList(void) {return theProductSubList;}
      linkList <product> * GettheProductAddList(void) {return theProductAddList;}

      // Other functions
      void InitializePrices(char* priceFileName,bsTime* astarttime,  bsTime* astoptime);
      void InitializeProducts(char* productFileName);//,bool cattle);
      void GiveIndicator();
      ...
      //Added by NJH to enable use of products by cattle
		void InitializeFeed(char* FeedFileName);
