...
class milk: public product
{
   ...
   public:
      ...
      friend ostream& operator << (ostream& os, const milk& amilk);
      // Set functions
      void Setfat(double& afat) {fat = afat;}
      void SetdryMatter(double& adryMatter) {dryMatter = adryMatter;}

      // Get functions
      double Getfat(void) const {return fat;}
      double GetdryMatter(void) const {return dryMatter;}
      double Getprotein(void) const {return protein;}
      double Geturea(void) const {return urea;}
