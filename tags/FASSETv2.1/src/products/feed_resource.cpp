...
/****************************************************************************\
  Operator << for output
\****************************************************************************/
ostream& operator<< (ostream& os, const feed_resource& afeed_resource)       //not called
{
   os << setiosflags(ios::left) << setw(40) << "Supplement " << afeed_resource.GetIsSupplement() << endl; //
	os << setiosflags(ios::left) << setw(40) << "areaOccupied" << afeed_resource.Getarea_occupied() << endl;
	os << setiosflags(ios::left) << setw(40) << "timeSinceDunged" << afeed_resource.GetTime_since_dunged() << endl;
	return os;
}
