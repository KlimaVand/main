...
/****************************************************************************\
  Operator << for output
\****************************************************************************/
ostream& operator<< (ostream& os, const feedItem& afeedItem)
{
  os << (liveMatter &) afeedItem;
  os << setiosflags(ios::left) << setw(40) << "Protein digestibility " << afeedItem.proteinN_digestibility << endl;
  os << setiosflags(ios::left) << setw(40) << "feedUnitsPerItemUnit " << afeedItem.feedUnitsPerItemUnit << endl;
  os << setiosflags(ios::left) << setw(40) << "Ca_content " << afeedItem.Ca_content << endl;
  os << setiosflags(ios::left) << setw(40) << "Na_content " << afeedItem.Na_content << endl;
  os << setiosflags(ios::left) << setw(40) << "Mg_content " << afeedItem.Mg_content << endl;
  os << setiosflags(ios::left) << setw(40) << "Cu_content " << afeedItem.Cu_content << endl;
  os << setiosflags(ios::left) << setw(40) << "S_content " << afeedItem.S_content << endl;
  os << setiosflags(ios::left) << setw(40) << "Threonin " << afeedItem.Threonin << endl;
  os << setiosflags(ios::left) << setw(40) << "Lysin " << afeedItem.Lysin << endl;
  os << setiosflags(ios::left) << setw(40) << "fat " << afeedItem.fat << endl;
  os << setiosflags(ios::left) << setw(40) << "sugar " << afeedItem.sugar << endl;
  os << setiosflags(ios::left) << setw(40) << "starch " << afeedItem.starch << endl;
  os << setiosflags(ios::left) << setw(40) << "organic " << afeedItem.organic << endl;
  os << setiosflags(ios::left) << setw(40) << "chew " << afeedItem.chew << endl;
  os << setiosflags(ios::left) << setw(40) << "aat " << afeedItem.aat << endl;
  os << setiosflags(ios::left) << setw(40) << "pbv " << afeedItem.pbv << endl;
  os << setiosflags(ios::left) << setw(40) << "cell " << afeedItem.cell << endl;
  os << setiosflags(ios::left) << setw(40) << "fill " << afeedItem.fill << endl;
  os << setiosflags(ios::left) << setw(40) << "fillU " << afeedItem.fillU << endl;
  os << setiosflags(ios::left) << setw(40) << "PlantName " << afeedItem.plantName << endl;
  os << setiosflags(ios::left) << setw(40) << "P_digest " << afeedItem.P_digest << endl;
  os << setiosflags(ios::left) << setw(40) << "max percentage " << afeedItem.MaxPercentage << endl;
  os << setiosflags(ios::left) << setw(40) << "OMD " << afeedItem.OMD<< endl;
  os << setiosflags(ios::left) << setw(40) << "catfeedItem - items missing!!" << endl;
  return os;
}
...
product& feedItem::operator=(const product& someFeedItem)
{
   ...
   proteinN_digestibility         = aFeedItem->GetproteinN_digestibility();
	...
	S_content              = aFeedItem->GetS_content();
...
product& feedItem::operator+(const product& someFeedItem)
{
 	...
 	if (aFeedItem->GetObjType()==feedItemObj)
   {
	   ...
	   double aproteinN_digestibility         = aFeedItem->GetproteinN_digestibility();
		...
		double aS_content              = aFeedItem->GetS_content();
...
/****************************************************************************\
\****************************************************************************/
void feedItem::SetPlantName(char aplantname[MAX_TXT])
{
	plantName.append(aplantname);
}

/****************************************************************************\
\****************************************************************************/
string feedItem::DerivedFrom() const
{
	return GetPlantName();
}
...
\****************************************************************************/
void feedItem::CopyFromPlantItem(const plantItem& somePlantItem, int feedCat)
{
