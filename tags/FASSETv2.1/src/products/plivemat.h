...
/****************************************************************************\
   Class: liveMatter
	   is the superclass of decomposable and feedItem.
\****************************************************************************/

class liveMatter: public product
{
   protected:
      nitrogen orgN_content;   		// fraction N in orgN of total amount
      nitrogen NH4_content;    		// fraction N in NH4 of total amount
      nitrogen NO3_content;    		// fraction N in NO3 of total amount
   	double P_content;
      double K_content;
      double dryMatter;
      double C_content;
      double organic;
      int code;							//code used to link plantItem and feedItem
      void InitVariables();
   ...
   public:
      ...
      virtual ~liveMatter();
      // Operator for output
      friend ostream& operator << (ostream& os, const liveMatter& aliveMatter);
