...
\****************************************************************************/
void technics::Initialize(char * opFileName, char * techFileNameFarm)
{
...
\****************************************************************************/
void technics::CreateOperationList(char * aFileName)
{
   SetCritical();
...
/****************************************************************************\
\****************************************************************************/
void technics::CreateFarmList(char * fileName)
{
