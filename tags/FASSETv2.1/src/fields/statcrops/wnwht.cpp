...
static_wnwht::static_wnwht()
{
	strcpy(cropName,"WNWHT");
}

double static_wnwht::PVstratFactor(int PV_strat)
{
	double f=1.00;
	switch (PV_strat)
   {
...
void static_wnwht::SpecifiedPlan(fieldOrder * PP,int JB_NO,char * crop_id)
{
...
cloneList<fieldOperationFields> * static_wnwht::MakeOpList(fieldOrder * PP,int JB_NO,double reduction)
{
...
int static_wnwht::NumOfProtectStrat_()
{
	return Num_of_pr_str;
}

int static_wnwht::NitrogenLevels_()
{
	return Nitrogen_levels;
}

double static_wnwht::NitrogenAmount(int JB_NO,double free_N,int N_level)
{
	double N=Nopt(JB_NO);
	switch (N_level) {
		case 0: N=0;break;
...
double static_wnwht::Nopt(int JB_NO)
{
...
double static_wnwht::Ymin(int JB_NO)
{
	if (JB_NO>4) // Clayish soil
		return 4.0;
	else {       // Sandy soil
...
double static_wnwht::Ymax(int JB_NO)
{
	if (JB_NO>4) // Clayish soil
		return 8.0;
	else {       // Sandy soil
...
double static_wnwht::ExpectedYield_(int JB_NO,int N_level,int PV_strat)
{
...
double static_wnwht::PhosphorAmount_()
{
	return 25;
}

double static_wnwht::PotassiumAmount_()
{
	return 60;
}

double static_wnwht::ExtraNRelease_()
{
	return 0;
}

int static_wnwht::SlyrryPossibleThisPeriod(period * p)
{
...
double static_wnwht::ExpectedStrawYield_(int JB_NO,int N_level,int PV_strat)
{
   if (gatheringStraw)
