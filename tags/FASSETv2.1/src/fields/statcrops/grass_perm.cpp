...
static_grass_perm::static_grass_perm()
{
	strcpy(cropName,"GRASS");
}

cloneList<fieldOperationFields> * static_grass_perm::MakeOpList(fieldOrder * PP,int JB_NO,double reduction)
{
...
int static_grass_perm::NumOfProtectStrat_()
{
	return 1; 
}

int static_grass_perm::NitrogenLevels_()
{
	return 1;
}

int static_grass_perm::FallowCrop()
{
	return 1;
}

double static_grass_perm::ExtraNRelease_()
{
	return 0.0;
}
