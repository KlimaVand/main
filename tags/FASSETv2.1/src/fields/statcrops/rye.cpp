...
/****************************************************************************\
\****************************************************************************/
double static_rye::PVstratFactor(int PV_strat)
{
	double f=1.00;
	switch (PV_strat)
   {
...
/****************************************************************************\
\****************************************************************************/
void static_rye::SpecifiedPlan(fieldOrder * PP,int JB_NO,char * crop_id)
{
...
/****************************************************************************\
\****************************************************************************/
cloneList<fieldOperationFields> * static_rye::MakeOpList(fieldOrder * PP,int JB_NO,double reduction)
{
   ...
   */
   ...
   { // Automatic plan
      ...
      { // Sowing
         ...
         FO->DefineSowFieldsOp(Sowing,crop_id,cropName,PP->GetStartYear(),10,4,PP->GetArea(),0,PP->GetDistance(),PP->GetPVStrat(),reduction,aSeed);
         AddOpList(FO);
         delete aSeed;
      }
...
/****************************************************************************\
\****************************************************************************/
int static_rye::NumOfProtectStrat_()
{
...
/****************************************************************************\
\****************************************************************************/
int static_rye::NitrogenLevels_()
{
...
/****************************************************************************\
\****************************************************************************/
double static_rye::NitrogenAmount(int JB_NO,double free_N,int N_level)
{
	double N=Nopt(JB_NO);
	switch (N_level) {
		case 0: N=0;break;
...
/****************************************************************************\
\****************************************************************************/
double static_rye::Nopt(int JB_NO)
{
...
/****************************************************************************\
\****************************************************************************/
double static_rye::Ymin(int JB_NO)
{
	if (JB_NO>4) // Clayish soil
		return 4.0;
	else {       // Sandy soil
...
/****************************************************************************\
\****************************************************************************/
double static_rye::Ymax(int JB_NO)
{
	if (JB_NO>4) // Clayish soil
		return 8.0;
	else {       // Sandy soil
...
/****************************************************************************\
\****************************************************************************/
double static_rye::ExpectedYield_(int JB_NO,int N_level,int PV_strat)
{
...
/****************************************************************************\
\****************************************************************************/
double static_rye::PhosphorAmount_()
{
	return 25;
}
...
/****************************************************************************\
\****************************************************************************/
double static_rye::PotassiumAmount_()
{
	return 60;
}
...
/****************************************************************************\
\****************************************************************************/
double static_rye::ExtraNRelease_()
{
	return 0;
}
...
/****************************************************************************\
\****************************************************************************/
int static_rye::SlyrryPossibleThisPeriod(period * p)
{
...
/****************************************************************************\
\****************************************************************************/
double static_rye::ExpectedStrawYield_(int JB_NO,int N_level,int PV_strat)
{
   if (gatheringStraw)
