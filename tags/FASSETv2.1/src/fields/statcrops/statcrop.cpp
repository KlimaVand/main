...
char * staticCrop::GetSeedName(char * crop_id)
{
   ...
   if (strcmp(crop_id,"B1")==0 || strcmp(crop_id,"B2")==0)
      return "SEEDSPBARL";
   if (strcmp(crop_id,"F1")==0 || strcmp(crop_id,"G1")==0 || strcmp(crop_id,"GR")==0 || strcmp(crop_id,"S1")==0)
      return "SEEDRYEGRASS";
   ...
   if (strcmp(crop_id,"OR")==0)
      return "SEEDOILRADISH";
   if (strcmp(crop_id,"CH")==0)
      return "SEEDCHICKORY";
   if (strcmp(crop_id,"DW")==0)
      return "SEEDDYERSWOAD";
   if (strcmp(crop_id,"IR")==0)
      return "SEEDITALRYEGRASS";   //added NJH May 2009
   if (strcmp(crop_id,"SF")==0)
      return "SEEDSUNFLOWER";   //added NJH May 2009
   if (strcmp(crop_id,"SB")==0)
      return "SEEDSOYABEAN";   //added NJH May 2009
   if (strcmp(crop_id,"L1")==0)
      return "SEEDLUCERNE";   //added NJH May 2009
...
//      if (strlen((char*)PP->GetSowCrop(i)->c_str())>2)
...
cloneList<fieldOperationFields> * staticCrop::MakeOpList(fieldOrder * PP,int JB_NO,double reduction)
{
   ...
   reduction=reduction;
	...
	ResetOpList();
	if (!PP->GetAutomatic())
      SpecifiedPlan(PP,JB_NO,"NO");                  // This should only be called with NO crops on field!
   if (LP->NumOfNodes()==0)
   {
	   int yearOffset=0;
 ...
 double staticCrop::ExtraNRelease_()
{
	...
	// beets 10
	// fallow 0
	// After: "Håndbog for plantedyrkning 1995".
	return 0;
}
