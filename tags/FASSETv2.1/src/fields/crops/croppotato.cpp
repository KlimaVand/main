           ...
           :crop(aName,aIndex,aOwner)
{
   ...
   MaxRadUseEff      = 4.0;          // Maximum radiation use efficiency (g/MJ)
	...
	MinAllocToRoot    = 0.3;          // Minimal fraction of dry matter production that is allocated to the root - Value from beet
   MaxAllocToRoot    = 0.3;          // Maximal fraction of dry matter production that is allocated to the root - Value from beet
   MinAllocToStorage = 0.0;          // Min. allocation to storage organs
   ...
   MinN_Store    = 0.011;            // Minimum content of nitrogen i storage organs
	MaxN_Store    = 0.016;            // Maximum content of nitrogen i storage organs
   ...
   PowDM         = -0.56;         	 // Power of dry matter
   NPctMax       = 8.0;          	 // Following Justes concept (taken af 8.3* (5.21/5.35) to find Nmaxpct from Nc)
   ...
   // Phenology
	Phenology->TS0          = 150;              // Planting to emergence - ca 25 dage - lægges sidst i april
   Phenology->TS1          = 235;              // Emergence to anthesis
   Phenology->TS2          = 3650;             // Anthesis to end of "grain"-filling
