        ...
        :crop(aName,aIndex,aOwner)
{
   ...
   WaterDeficitGrainFill = 0.70;
	...
	MinAllocToRoot=0.1;               // Minimal fraction of dry matter production that is allocated to the root. Taken from winter wheat
   ...
   MinN_Store    = 0.011;            // Minimum content of nitrogen in storage organs
	...
	//MinN_Straw    = 3.8/3.3*0.003;    // Minimum content of nitrogen in storage organs. Adjusted according to Fodermiddeltabel
	//MaxN_Straw    = 3.8/3.3*0.01;     // Maximum content of nitrogen in storage organs. Adjusted according to Fodermiddeltabel
...
//	TempSumR2=700;                    // See p. 160 in DAISY-description. Value taken from winter wheat
   ...
   RhizoDepositFraction=0.5;
	NitrateUptakeRate  	= 0.00003;    // Calibration based on data from Landforsøgene
