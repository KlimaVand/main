 ...
 */
   ...
   */
   crop * AllocateCrop(char * crop_id, char * cropName);
...
public:
   ...
   void Initialise(char * soilFileName, int aIndex = 0, double anArea = 0.0);
...
//   void HandleOp(fieldOperationFields * FOP);
   ...
   */
   ...
   void Incorporate(double depth, double frac){aSoil->Incorporate(depth, frac);};
