...
bool mineralFertFields::CalcCost(linkList<operation>    * aOperationList,
                                    ...
                                    bool                  update)
{
   if (!update && ((mode==hoursTotalNotCombineNotFert) || (mode==hoursCombine)
      || (mode==hoursAnimalFert) || (mode==hoursPlantCare)
      || (mode==varCostTotalNotFert) || (mode==varCostAnimalFert)))
      return false;
...
/****************************************************************************\
\****************************************************************************/
void mineralFertFields::Output(fstream * fs)
{
