...
#include <clonlist.h>
#include <base.h> //Required for all FASSET classes
#ifdef _STANDALONE
	#include <output.h>
  	#include <message.h>
#else
 ...
 #include <intake.h> //Required for include files
#include <panimal.h>
#include <budget.h>
...
class animal: public base
{
 ...
 double normNExcretion;   /*NOT USED*/				//standard total N excretion (kg per year)
 ...
 double P_need;                     // P needed for growth
 double K_need;                     // K needed for growth
...
public:
  ...
  virtual ~ animal ( ); //Destructor
   ...
   virtual double GetheatProduction() {return heatProduction;}
   virtual double GetnormNExcretion() {return normNExcretion;}
