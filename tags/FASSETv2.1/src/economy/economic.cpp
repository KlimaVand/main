...
void economics::GiveIndicator()
{
   ...
   Nlevy3 -= theOutput->GetAmount(environmentalIndicator,"35.20 N in sold plant products");
	...
	Nlevy4  = theLegislation->GetCurrentTax(3)->getTax()*(Nlevy3-theLegislation->GetCurrentTax(3)->getLevel());
   Nlevy1 *= theLegislation->GetCurrentTax(0)->getTax();
	Nlevy2 *= theLegislation->GetCurrentTax(1)->getTax();
	Nlevy3 *= theLegislation->GetCurrentTax(2)->getTax();
