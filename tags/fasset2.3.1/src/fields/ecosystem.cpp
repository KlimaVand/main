...
void ecosystem::GiveIndicators()
{
   ...
   theOutput->AddStateIndicator(environmentalIndicator,"40.60 Total C in soil","kg C",aSoil->GetTotalCarbon()*area*10);  //GetPoolCarbon(const char * Name, double startDep, double thick)
	...
	theOutput->AddStateIndicator(environmentalIndicator,"40.66 C in AOM+SMB 0-25 cm","kg C",
		...
		theOutput->AddStateIndicator(environmentalIndicator,"40.70 C in NOM 0-25 cm","kg C",aSoil->GetPoolCarbon(5,0,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"40.71 C in NOM 25-50 cm","kg C",aSoil->GetPoolCarbon(5,250,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"40.72 C in NOM 50-75 cm","kg C",aSoil->GetPoolCarbon(5,500,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"40.73 C in NOM 75-250 cm","kg C",aSoil->GetPoolCarbon(5,750,1750)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"40.74 C in IOM 0-25 cm","kg C",aSoil->GetPoolCarbon(6,0,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"40.75 C in IOM 25-50 cm","kg C",aSoil->GetPoolCarbon(6,250,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"40.76 C in IOM 50-75 cm","kg C",aSoil->GetPoolCarbon(6,500,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"40.77 C in IOM 75-250 cm","kg C",aSoil->GetPoolCarbon(6,750,1750)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"40.90 AOM1 C in soil","kg C",aSoil->GetPoolCarbon(0,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"40.91 AOM2 C in soil","kg C",aSoil->GetPoolCarbon(1,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"40.92 SMB1 C in soil","kg C",aSoil->GetPoolCarbon(2,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"40.93 SMB2 C in soil","kg C",aSoil->GetPoolCarbon(3,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"40.94 SMR C in soil","kg C",aSoil->GetPoolCarbon(4,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"40.95 NOM C in soil","kg C",aSoil->GetPoolCarbon(5,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"40.96 IOM C in soil","kg C",aSoil->GetPoolCarbon(6,0,balanceDepth)*area*10);

   theOutput->AddIndicator(environmentalIndicator,"40.40 CO2 soil respiration","kg C",aSoil->GetCO2Evolution()*area*10);

   theOutput->AddStateIndicator(environmentalIndicator,"32.62 AOM1 N in soil","kg N",aSoil->GetPoolNitrogen(0,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"32.63 AOM2 N in soil","kg N",aSoil->GetPoolNitrogen(1,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"32.64 SMB1 N in soil","kg N",aSoil->GetPoolNitrogen(2,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"32.65 SMB2 N in soil","kg N",aSoil->GetPoolNitrogen(3,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"32.66 SMR N in soil","kg N",aSoil->GetPoolNitrogen(4,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"32.67 NOM N in soil","kg N",aSoil->GetPoolNitrogen(5,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"32.68 IOM N in soil","kg N",aSoil->GetPoolNitrogen(6,0,balanceDepth)*area*10);
   theOutput->AddStateIndicator(environmentalIndicator,"32.60 Organic N in soil","kg N",(aSoil->GetTotalNitrogen(0,balanceDepth)-aSoil->GetMinNitrogen(0,balanceDepth))*area*10);
	...
	theOutput->AddStateIndicator(environmentalIndicator,"32.77 N in AOM+SMB 0-25 cm","kg N",
	   	(aSoil->GetPoolNitrogen(0,0,250)+aSoil->GetPoolNitrogen(1,0,250)+aSoil->GetPoolNitrogen(2,0,250)+
	      aSoil->GetPoolNitrogen(3,0,250)+aSoil->GetPoolNitrogen(4,0,250))*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.78 N in AOM+SMB 25-50 cm","kg N",
	   	(aSoil->GetPoolNitrogen(0,250,250)+aSoil->GetPoolNitrogen(1,250,250)+aSoil->GetPoolNitrogen(2,250,250)+
	      aSoil->GetPoolNitrogen(3,250,250)+aSoil->GetPoolNitrogen(4,250,250))*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.79 N in AOM+SMB 50-75 cm","kg N",
	   	(aSoil->GetPoolNitrogen(0,500,250)+aSoil->GetPoolNitrogen(1,500,250)+aSoil->GetPoolNitrogen(2,500,250)+
	      aSoil->GetPoolNitrogen(3,500,250)+aSoil->GetPoolNitrogen(4,500,250))*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.80 N in AOM+SMB 75-250 cm","kg N",
	   	(aSoil->GetPoolNitrogen(0,750,1750)+aSoil->GetPoolNitrogen(1,750,1750)+aSoil->GetPoolNitrogen(2,750,1750)+
	      aSoil->GetPoolNitrogen(3,750,1750)+aSoil->GetPoolNitrogen(4,750,1750))*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.81 N in NOM 0-25 cm","kg N",aSoil->GetPoolNitrogen(5,0,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.82 N in NOM 25-50 cm","kg N",aSoil->GetPoolNitrogen(5,250,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.90 N in NOM 50-75 cm","kg N",aSoil->GetPoolNitrogen(5,500,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.91 N in NOM 75-250 cm","kg N",aSoil->GetPoolNitrogen(5,750,1750)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.92 N in IOM 0-25 cm","kg N",aSoil->GetPoolNitrogen(6,0,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.93 N in IOM 25-50 cm","kg N",aSoil->GetPoolNitrogen(6,250,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.94 N in IOM 50-75 cm","kg N",aSoil->GetPoolNitrogen(6,500,250)*area*10);
		theOutput->AddStateIndicator(environmentalIndicator,"32.95 N in IOM 75-250 cm","kg N",aSoil->GetPoolNitrogen(6,750,1750)*area*10);
...
void ecosystem::Sow(char * cropID, double SeedDensDryMatt,double RelativeDensity,double NitrogenInSeed, double CarbonInSeed)
{
   ...
   {  // Remove all bare "crops"
	...
	theCrops->InsertLast(aCrop);
      ...
      theOutput->AddIndicator(environmentalIndicator,"40.03 C from seed","kg C",CarbonInSeed*area*10.0);
#endif
};
