...
{
   theOutput->AddIndicator(703,"07.03 Depreciation machinery","Dkr",-getDepreciationValue());
   theOutput->AddIndicator(705,"07.05 Insurance machinery","Dkr",-getInsuranceValue());
   theOutput->AddIndicator(707,"07.07 Maintenance machinery","Dkr",-getMaintenanceValue());
   theOutput->AddIndicator(303,"03.03 Value of machinery","Dkr",NewValue*AverageValuePercent);
}
