...
public:
   ...
   pF_Curve_Implementation(char * Pname, int Intpol = 0);
   ...
   void AddExternalConductionData(double pFValue, double logCond);
   void ReadParameters(commonData * data,int index,double dryBulkDensity,double clayContent,double siltContent,double carbon, bool TopSoil);
};
