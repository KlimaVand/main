...
class manure: public decomposable
{
   ...
   public:
      ...
      manure(const char * aName, const int aIndex = -1, const base * aOwner = nullptr);
      // Copy Constructor
      ...
      void SetNH3emissionFactor(double input){NH3emissionFactor=input;}
      // Get functions
      string GetfromAnimal(void) const {return Alias;}
...
*/
	  ...
	  */
		virtual double InstantaneousVolatAmmonia(double temperature, double area, double resistance);
