...

{
   ...
   if (aForageProduct==nullptr)
      theMessage->FatalError("harvestFields::AddForageProduct - function called with nullptr");
   if (ForageProduct[i]==nullptr)
      theMessage->FatalError("harvestFields::AddForageProduct - can not add product to nullptr product pointer");
