...
/****************************************************************************\
\****************************************************************************/
cloneList<fieldOperationFields> * staticFallow::MakeOpList(fieldOrder * PP,int JB_NO)
{
...
int staticFallow::NumOfProtectStrat_()
{
	return 1;
}

int staticFallow::NitrogenLevels_()
{
	return 1;
}

int staticFallow::FallowCrop()
{
	return 1;
}

double staticFallow::ExtraNRelease_()
{
	return 0.0;
}
