 ...
 */
void instore::floorVolatize(double airVelocity, double tempWaterEvap, double temperature, double areaSoiled, double duration,
...
void instore::inhouseVolatize(double airVelocity, double tempWaterEvap, double temperature, double duration,
		double *volatAmmonia, double *N2Emission, double *N2OEmission, double *CH4Emission, double *CO2Emission)
{
	if (airVelocity>0.0)
	{
