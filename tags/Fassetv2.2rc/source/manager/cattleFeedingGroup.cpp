...
********************************************************************/
void cattleFeedingGroup::ReadParameters(char *feedFileName, bool autoFeed)
{
...
/*******************************************************************
********************************************************************/
double cattleFeedingGroup::GetCattleIntake()
{
//	int feedingGroup;
   double ret_val=0.0;
...
\****************************************************************************/
void cattleFeedingGroup::GetRoughageRequired(linkList <product> *aList)
{
   double number = 0;
...
/****************************************************************************\
\****************************************************************************/
double cattleFeedingGroup::GetGrassSilageRequired()
{
	double ret_val=0.0;
...
double cattleFeedingGroup::GetEnergyRequirement()
{
   double ret_val= 0;
   for(int j=0;j<theGroup->NumOfNodes();j++)
   {
