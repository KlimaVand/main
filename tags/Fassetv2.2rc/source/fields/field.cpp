...
void field::OutputPlantDetails(bool header)
{
	if (header)
	{
      ...
      {
      	f << "\tCropName\tphase\tTempSum\tGLAI\tYLAI\tDMRoot\tDMRootPL\tDMRootTubers\tDMtop\tDMStorage\tDMTotalTop";
     	   f << "\tTranspirationRatio\tHeight\tRootDepth\tTotalRootLength\tInterceptedRadiation";
