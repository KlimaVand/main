...
// State variables
   ...
   //! return true if the plan has been sowed
   bool Sown() {return DS>=-1.0;};
   //! return true if the planed has begun to grow
   bool Emerged() {return DS>=0.0;};
   //! return true if the plans flower is fully functional
   bool Anthesis() {return DS>=1.0;};
   //! return true if the grain has started with developing
