           ...
           :crop(aName,aIndex,aOwner)
{
   ...
   Phenology->TS1          = 250;              // Emergence to anthesis, fittet on 3 N levels, 4 years (Foulum)
   Phenology->TS2          = 600;              // Anthesis to end of grainfilling , fittet on 3 N levels, 4 years (Foulum)
   Phenology->TS3          = 145;              // End of grainfilling to ripeness
