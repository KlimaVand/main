...
//!the total leaf area index - input from ecosystem
      ...
      //!stores the amount of grain dry matter and nitrogen currently present in the crops
		plantItem * MainProduct[MaxPlants];
      //!stores the amount of Straw and leaf dry matter and nitrogen currently present in the crops
...
/*   double GetTotalLAI(){return totalLAI;};
   ...
   */
   ...
   //!returns the quantity and quality of herbage from a patch. requires updating
   /*!
   \param my_resource pointer to a class describing the quantity and quality of material available
   \param grazing_height height to which the herbage is grazed (millimetres)
   \param min_stubble_ht minimum height to which herbage may be grazed(millimetres)
   \param animalType identifier of the animal that is grazing
   */
