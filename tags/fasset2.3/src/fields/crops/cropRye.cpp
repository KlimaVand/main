        ...
        :crop(aName,aIndex,aOwner, cropName)
{
   ...
   HeightA = theCropData->getHeightA();                   // See Olesen, 2002 for description. Value taken from winter wheat
   HeightB =theCropData->getHeightB();                   // Value taken from winter wheat
